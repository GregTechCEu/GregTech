...
public class DriverPowerSubstation extends DriverSidedTileEntity {
    ...
    public ManagedEnvironment createEnvironment(World world, BlockPos pos, EnumFacing side) {
        TileEntity tileEntity = world.getTileEntity(pos);
        if (tileEntity instanceof IGregTechTileEntity gtte && gtte.getMetaTileEntity() instanceof MetaTileEntityPowerSubstation pss) {
            return new EnvironmentPowerSubstation(gtte, pss);
        }
        return null;
    }

    public final static class EnvironmentPowerSubstation extends EnvironmentMetaTileEntity<MetaTileEntityPowerSubstation> {
