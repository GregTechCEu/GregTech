...
public class PowderbarrelRenderer extends Render<PowderbarrelEntity> {
    ...
    public void doRender(PowderbarrelEntity entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        brd.renderBlockBrightness(MetaBlocks.POWDERBARREL.getDefaultState(), entity.getBrightness());
        GlStateManager.translate(0.0F, 0.0F, 1.0F);
        if (this.renderOutlines) {
            GlStateManager.enableColorMaterial();
            GlStateManager.enableOutlineMode(this.getTeamColor(entity));
            brd.renderBlockBrightness(MetaBlocks.POWDERBARREL.getDefaultState(), 1.0F);
    ...
    @Override
    protected ResourceLocation getEntityTexture(@NotNull PowderbarrelEntity entity) {
