...
public class SafeRenderer implements IconRegistrar {

    private static final Cuboid6 mainBoxOuter = new Cuboid6(3 / 16.0, 0 / 16.0, 3 / 16.0, 13 / 16.0, 14 / 16.0,
            13 / 16.0);
    private static final Cuboid6 mainBoxInner = new Cuboid6(4 / 16.0, 1 / 16.0, 3 / 16.0, 12 / 16.0, 13 / 16.0,
            12 / 16.0);
    ...
    public void render(CCRenderState renderState, Matrix4 translation, IVertexOperation[] pipeline, EnumFacing rotation,
        ...
        for (EnumFacing renderSide : EnumFacing.VALUES) {
            TextureAtlasSprite doorSprite = renderSide == EnumFacing.NORTH ? textures[6] :
