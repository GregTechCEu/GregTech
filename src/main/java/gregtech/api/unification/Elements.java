...
public class Elements {
    ...
    public static final Element B = add(5, 6, "Boron", "B");
    ...
    public static final Element F = add(9, 10, "Fluorine", "F");
    public static final Element Ne = add(10, 10, "Neon", "Ne");
    public static final Element Na = add(11, 12, "Sodium", "Na");
    public static final Element Mg = add(12, 12, "Magnesium", "Mg");
    public static final Element Al = add(13, 14, "Aluminium", "Al");
    public static final Element Si = add(14, 14, "Silicon", "Si");
    public static final Element P = add(15, 16, "Phosphorus", "P");
    ...
    public static final Element Zn = add(30, 34, "Zinc", "Zn");
    public static final Element Ga = add(31, 38, "Gallium", "Ga");
    public static final Element Ge = add(32, 42, "Germanium", "Ge");
    public static final Element As = add(33, 42, "Arsenic", "As");
    public static final Element Se = add(34, 46, "Selenium", "Se");
    public static final Element Br = add(35, 44, "Bromine", "Br");
    public static final Element Kr = add(36, 48, "Krypton", "Kr");
    public static final Element Rb = add(37, 48, "Rubidium", "Rb");
    public static final Element Sr = add(38, 50, "Strontium", "Sr");
    public static final Element Y = add(39, 50, "Yttrium", "Y");
    public static final Element Zr = add(40, 50, "Zirconium", "Zr");
    public static final Element Nb = add(41, 52, "Niobium", "Nb");
    public static final Element Mo = add(42, 56, "Molybdenum", "Mo");
    public static final Element Tc = add(43, 56, "Technetium", "Tc");
    public static final Element Ru = add(44, 58, "Ruthenium", "Ru");
    ...
    public static final Element Cd = add(48, 66, "Cadmium", "Cd");
    public static final Element In = add(49, 64, "Indium", "In");
    public static final Element Sn = add(50, 70, "Tin", "Sn");
    public static final Element Sb = add(51, 70, "Antimony", "Sb");
    public static final Element Te = add(52, 74, "Tellurium", "Te");
    public static final Element I = add(53, 74, "Iodine", "I");
    public static final Element Xe = add(54, 78, "Xenon", "Xe");
    public static final Element Cs = add(55, 77, "Caesium", "Cs");
    public static final Element Ba = add(56, 82, "Barium", "Ba");
    public static final Element La = add(57, 82, "Lanthanum", "La");
    public static final Element Ce = add(58, 82, "Cerium", "Ce");
    public static final Element Pr = add(59, 82, "Praseodymium", "Pr");
    public static final Element Nd = add(60, 82, "Neodymium", "Nd");
    public static final Element Pm = add(61, 86, "Promethium", "Pm");
    public static final Element Sm = add(62, 90, "Samarium", "Sm");
    public static final Element Eu = add(63, 90, "Europium", "Eu");
    public static final Element Gd = add(64, 94, "Gadolinium", "Gd");
    public static final Element Tb = add(65, 94, "Terbium", "Tb");
    public static final Element Dy = add(66, 98, "Dysprosium", "Dy");
    public static final Element Ho = add(67, 98, "Holmium", "Ho");
    public static final Element Er = add(68, 98, "Erbium", "Er");
    public static final Element Tm = add(69, 100, "Thulium", "Tm");
    public static final Element Yb = add(70, 104, "Ytterbium", "Yb");
    public static final Element Lu = add(71, 104, "Lutetium", "Lu");
    public static final Element Hf = add(72, 106, "Hafnium", "Hf");
    public static final Element Ta = add(73, 108, "Tantalum", "Ta");
    public static final Element W = add(74, 110, "Tungsten", "W");
    public static final Element Re = add(75, 110, "Rhenium", "Re");
    ...
    public static final Element Au = add(79, 118, "Gold", "Au");
    public static final Element Hg = add(80, 122, "Mercury", "Hg");
    public static final Element Tl = add(81, 124, "Thallium", "Tl");
    public static final Element Pb = add(82, 126, "Lead", "Pb");
    public static final Element Bi = add(83, 126, "Bismuth", "Bi");
    public static final Element Po = add(84, 126, "Polonium", "Po");
    public static final Element At = add(85, 125, "Astatine", "At");
    public static final Element Rn = add(86, 134, "Radon", "Rn");
    public static final Element Fr = add(87, 136, "Francium", "Fr");
    public static final Element Ra = add(88, 138, "Radium", "Ra");
    public static final Element Ac = add(89, 138, "Actinium", "Ac");
    public static final Element Th = add(90, 142, "Thorium", "Th");
    public static final Element Pa = add(91, 140, "Protactinium", "Pa");
    ...
    public static final Element Am = add(95, 148, "Americium", "Am");
    public static final Element Cm = add(96, 152, "Curium", "Cm");
    public static final Element Bk = add(97, 150, "Berkelium", "Bk");
    ...
    public static final Element Rf = add(104, 163, "Rutherfordium", "Rf");
    public static final Element Db = add(105, 163, "Dubnium", "Db");
    public static final Element Sg = add(106, 165, "Seaborgium", "Sg");
    public static final Element Bh = add(107, 160, "Bohrium", "Bh");
    public static final Element Hs = add(108, 163, "Hassium", "Hs");
    public static final Element Mt = add(109, 165, "Meitnerium", "Mt");
    public static final Element Ds = add(110, 172, "Darmstadtium", "Ds");
    public static final Element Rg = add(111, 171, "Roentgenium", "Rg");
    public static final Element Cn = add(112, 173, "Copernicium", "Cn");
    public static final Element Nh = add(113, 173, "Nihonium", "Nh");
    public static final Element Fl = add(114, 171, "Flerovium", "Fl");
    public static final Element Mc = add(115, 174, "Moscovium", "Mc");
