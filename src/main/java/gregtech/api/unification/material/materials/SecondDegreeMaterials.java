...
public class SecondDegreeMaterials {
    ...
    public static void register() {
        ...
        Glass = new Material.Builder(2000, "glass")
                ...
                .flags(GENERATE_LENS, NO_SMASHING, EXCLUDE_BLOCK_CRAFTING_RECIPES, DECOMPOSITION_BY_CENTRIFUGING, GENERATE_LOW_YIELD_RECIPES)
        ...
        BlackSteel = new Material.Builder(2011, "black_steel")
                ...
                .flags(EXT_METAL, GENERATE_FINE_WIRE, GENERATE_GEAR, GENERATE_FRAME, GENERATE_LOW_YIELD_RECIPES)
        ...
        CobaltBrass = new Material.Builder(2014, "cobalt_brass")
                ...
                .flags(EXT2_METAL, GENERATE_GEAR, GENERATE_LOW_YIELD_RECIPES)
        ...
        SteelMagnetic = new Material.Builder(2035, "steel_magnetic")
                ...
                .flags(GENERATE_ROD, IS_MAGNETIC, GENERATE_LOW_YIELD_RECIPES)
                .components(Steel, 1)
