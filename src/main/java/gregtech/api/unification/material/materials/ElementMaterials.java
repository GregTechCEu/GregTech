...
public class ElementMaterials {
    ...
    public static void register() {
        ...
        Aluminium = new Material.Builder(2, "aluminium")
                .ingot().fluid().ore()
                .color(0x80C8F0)
                .flags(EXT2_METAL, GENERATE_GEAR, GENERATE_SMALL_GEAR, GENERATE_RING, GENERATE_FRAME, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_FINE_WIRE, GENERATE_LOW_YIELD_RECIPES)
                .element(Elements.Al)
        ...
        Antimony = new Material.Builder(4, "antimony")
                ...
                .flags(MORTAR_GRINDABLE, GENERATE_LOW_YIELD_RECIPES)
                .element(Elements.Sb)
                .fluidTemp(904)
                .build();
        ...
        Copper = new Material.Builder(25, "copper")
                ...
                .flags(EXT_METAL, MORTAR_GRINDABLE, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_FINE_WIRE, GENERATE_LOW_YIELD_RECIPES)
                .element(Elements.Cu)
        ...
        Gold = new Material.Builder(41, "gold")
                ...
                .flags(EXT2_METAL, GENERATE_RING, MORTAR_GRINDABLE, EXCLUDE_BLOCK_CRAFTING_BY_HAND_RECIPES, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_FINE_WIRE, GENERATE_FOIL, GENERATE_LOW_YIELD_RECIPES)
                .element(Elements.Au)
        ...
        Iron = new Material.Builder(51, "iron")
                ...
                .flags(EXT2_METAL, MORTAR_GRINDABLE, GENERATE_ROTOR, GENERATE_SMALL_GEAR, GENERATE_GEAR, GENERATE_SPRING_SMALL, GENERATE_SPRING, EXCLUDE_BLOCK_CRAFTING_BY_HAND_RECIPES, BLAST_FURNACE_CALCITE_TRIPLE, GENERATE_LOW_YIELD_RECIPES)
                .element(Elements.Fe)
        ...
        Lead = new Material.Builder(55, "lead")
                .ingot(1).fluid().ore()
                .color(0x8C648C)
                .flags(EXT2_METAL, MORTAR_GRINDABLE, GENERATE_ROTOR, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_FINE_WIRE, GENERATE_LOW_YIELD_RECIPES)
                .element(Elements.Pb)
        ...
        Manganese = new Material.Builder(61, "manganese")
                .ingot().fluid()
                .color(0xCDE1B9)
                .flags(STD_METAL, GENERATE_FOIL, GENERATE_BOLT_SCREW, GENERATE_LOW_YIELD_RECIPES)
                .element(Elements.Mn)
        ...
        Molybdenum = new Material.Builder(64, "molybdenum")
                ...
                .element(Elements.Mo)
                .flags(GENERATE_FOIL, GENERATE_BOLT_SCREW, GENERATE_LOW_YIELD_RECIPES)
        ...
        Nickel = new Material.Builder(69, "nickel")
                ...
                .flags(STD_METAL, MORTAR_GRINDABLE, GENERATE_LOW_YIELD_RECIPES)
                .element(Elements.Ni)
        ...
        Zinc = new Material.Builder(122, "zinc")
                ...
                .flags(STD_METAL, MORTAR_GRINDABLE, GENERATE_FOIL, GENERATE_RING, GENERATE_FINE_WIRE, GENERATE_LOW_YIELD_RECIPES)
                .element(Elements.Zn)
                .fluidTemp(693)
                .build();
