...
public class ElementMaterials {
    ...
    public static void register() {
        ...
        Europium = new Material.Builder(33, "europium")
                ...
                .flags(STD_METAL, GENERATE_LONG_ROD, GENERATE_FINE_WIRE, GENERATE_SPRING, GENERATE_FOIL, GENERATE_FRAME, GENERATE_SPRING_SMALL)
                .element(Elements.Eu)
        ...
        Neutronium = new Material.Builder(127, "neutronium")
                .ingot(6).fluid()
                .color(0xFAFAFA)
                .flags(EXT_METAL, GENERATE_BOLT_SCREW, GENERATE_FRAME, GENERATE_FINE_WIRE)
                .element(Elements.Nt)
        ...
        Tritanium = new Material.Builder(128, "tritanium")
                ...
                .flags(EXT2_METAL, GENERATE_FRAME, GENERATE_RING, GENERATE_SMALL_GEAR, GENERATE_ROUND, GENERATE_FOIL, GENERATE_FINE_WIRE, GENERATE_GEAR, GENERATE_SPRING)
                .element(Elements.Tr)
