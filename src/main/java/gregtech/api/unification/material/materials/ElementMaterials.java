...
public class ElementMaterials {
    ...
    public static void register() {
        ...
        Iron = new Material.Builder(51, "iron")
                ...
                .flags(EXT2_METAL, MORTAR_GRINDABLE, GENERATE_ROTOR, GENERATE_SMALL_GEAR, GENERATE_GEAR, GENERATE_SPRING_SMALL, EXCLUDE_BLOCK_CRAFTING_BY_HAND_RECIPES, BLAST_FURNACE_CALCITE_TRIPLE, GENERATE_FINE_WIRE)
                .element(Elements.Fe)
        ...
        Tritanium = new Material.Builder(128, "tritanium")
                ...
                .flags(EXT2_METAL, GENERATE_FRAME, GENERATE_RING, GENERATE_SMALL_GEAR, GENERATE_ROUND, GENERATE_FINE_WIRE, GENERATE_GEAR)
                .element(Elements.Tr)
