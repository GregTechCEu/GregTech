...
public class ElementMaterials {
    ...
    public static void register() {
        ...
        Chromium = new Material.Builder(22, gregtechId("chromium"))
                .ingot(3).fluid()
        ...
        Platinum = new Material.Builder(80, gregtechId("platinum"))
                ...
                .flags(EXT2_METAL, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_FOIL, GENERATE_FINE_WIRE, GENERATE_RING, GENERATE_DOUBLE_PLATE)
                .element(Elements.Pt)
        ...
        Titanium = new Material.Builder(113, gregtechId("titanium"))
                .ingot(3).fluid()
        ...
        Tungsten = new Material.Builder(115, gregtechId("tungsten"))
                ...
                .flags(EXT2_METAL, GENERATE_FOIL, GENERATE_GEAR, GENERATE_DOUBLE_PLATE)
                .element(Elements.W)
                .rotorStats(7.0f, 3.0f, 2560)
