...
public class UnknownCompositionMaterials {
    ...
    public static void register() {
        ...
        LightlyHydroCrackedGas = new Material.Builder(1542, "lightly_hydrocracked_gas")
                .fluid(FluidTypes.GAS).color(0xB4B4B4).build();
