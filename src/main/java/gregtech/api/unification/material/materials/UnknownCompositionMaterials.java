...
public class UnknownCompositionMaterials {
    ...
    public static void register() {
        ...
        SluiceJuice = new Material.Builder(1650, gregtechId("sluice_juice"))
                .fluid()
                .color(0x5C3C24)
                .build();

        SluiceSand = new Material.Builder(1651, gregtechId("sluice_sand"))
                .dust()
                .color(0xA5A578).iconSet(FINE)
                .build();

        FlotationWaste = new Material.Builder(1652, gregtechId("flotation_waste"))
                .fluid()
                .color(0x3D1E10)
                .build();

        CopperSlag = new Material.Builder(1653, gregtechId("copper_slag"))
                .dust()
                .color(0xA65537).iconSet(ROUGH)
                .build();

        NickelSlag = new Material.Builder(1654, gregtechId("nickel_slag"))
                .dust()
                .color(0x7A858E).iconSet(ROUGH)
                .build();

        LeadSlag = new Material.Builder(1655, gregtechId("lead_slag"))
                .dust()
                .color(0x4B334B).iconSet(ROUGH)
                .build();

        ZincSlag = new Material.Builder(1656, gregtechId("zinc_slag"))
                .dust()
                .color(0x8C8C8C).iconSet(ROUGH)
                .build();

        LeadConcentrate = new Material.Builder(1657, gregtechId("lead_concentrate"))
                .fluid()
                .color(0x551E55)
        ...
        ZincConcentrate = new Material.Builder(1658, gregtechId("zinc_concentrate"))
                .fluid()
                .color(0xA18DA1)
                .flags(DISABLE_DECOMPOSITION)
                .build()
