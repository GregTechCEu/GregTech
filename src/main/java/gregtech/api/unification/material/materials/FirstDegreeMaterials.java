...
public class FirstDegreeMaterials {
    ...
    public static void register() {
        ...
        TungstenCarbide = new Material.Builder(396, "tungsten_carbide")
                ...
                .toolStats(60.0f, 2.0f, 1280, 21)
                .addDefaultEnchant(Enchantments.EFFICIENCY, 5)
