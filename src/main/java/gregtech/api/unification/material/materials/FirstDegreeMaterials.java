...
public class FirstDegreeMaterials {
    ...
    public static void register() {
        ...
        Hematite = new Material.Builder(255, gregtechId("hematite"))
                .dust().ore()
                .color(0x915A5A)
                .flags(MAGNETIC_ORE)
        ...
        Goethite = new Material.Builder(261, gregtechId("goethite"))
                .dust(1).ore()
        ...
        Sylvite = new Material.Builder(309, gregtechId("sylvite"))
                .dust(1).ore()
        ...
        Limonite = new Material.Builder(337, gregtechId("limonite"))
                .dust().ore()
        ...
        Alumina = new Material.Builder(383, gregtechId("alumina"))
                .dust()
        ...
        Bismuthinite = new Material.Builder(389, gregtechId("bismuthinite"))
                .dust().ore()
        ...
        Thorianite = new Material.Builder(390, gregtechId("thorianite"))
                .dust().ore(true)
                .color(0x001E00).iconSet(ROUGH)
                .components(Thorium, 1, Oxygen, 2)
                .build();

        LiquidNitrogen = new Material.Builder(391, gregtechId("liquid_nitrogen"))
                .fluid()
                .color(0x00BFC1)
                .flags(DISABLE_DECOMPOSITION)
        ...
        BlueVitriol = new Material.Builder(451, gregtechId("blue_vitriol"))
                .dust()
        ...
        GreenVitriol = new Material.Builder(452, gregtechId("green_vitriol"))
                .dust()
        ...
        RedVitriol = new Material.Builder(453, gregtechId("red_vitriol"))
                .dust()
        ...
        PinkVitriol = new Material.Builder(454, gregtechId("pink_vitriol"))
                .dust()
        ...
        CyanVitriol = new Material.Builder(455, gregtechId("cyan_vitriol"))
                .dust()
        ...
        WhiteVitriol = new Material.Builder(456, gregtechId("white_vitriol"))
                .dust()
        ...
        GrayVitriol = new Material.Builder(457, gregtechId("gray_vitriol"))
                .dust()
        ...
        PurpleVitriol = new Material.Builder(458, gregtechId("purple_vitriol"))
                .dust()
        ...
        ClayVitriol = new Material.Builder(459, gregtechId("clay_vitriol"))
                .dust()
        ...
        ChloroauricAcid = new Material.Builder(460, gregtechId("chloroauric_acid"))
                .fluid(FluidTypes.ACID)
                .color(0xFFC846)
                .flags(DISABLE_DECOMPOSITION)
        ...
        ChloroplatinicAcid = new Material.Builder(461, gregtechId("chloroplatinic_acid"))
                .fluid(FluidTypes.ACID)
                .color(0xFF4646)
                .flags(DISABLE_DECOMPOSITION)
        ...
        CarbonDisulfide = new Material.Builder(462, gregtechId("carbon_disulfide"))
                .fluid(FluidTypes.GAS)
                .color(0x302C01)
                .components(Carbon, 1, Sulfur, 2)
                .build();

        SodiumEthylXanthate = new Material.Builder(463, gregtechId("sodium_ethyl_xanthate"))
                .fluid()
                .color(0xEAF514)
                .components(Carbon, 3, Hydrogen, 5, Oxygen, 1, Sulfur, 2, Sodium, 1)
                .build();

        ChloropalladicAcid = new Material.Builder(464, gregtechId("chloropalladic_acid"))
                .fluid(FluidTypes.ACID)
                .color(0x6163D4)
                .flags(DISABLE_DECOMPOSITION)
