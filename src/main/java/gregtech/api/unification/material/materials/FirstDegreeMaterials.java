...
public class FirstDegreeMaterials {
    ...
    public static void register() {
        ...
        AnnealedCopper = new Material.Builder(252, "annealed_copper")
                ...
                .flags(EXT2_METAL, MORTAR_GRINDABLE, GENERATE_FINE_WIRE, GENERATE_LOW_YIELD_RECIPES)
                .components(Copper, 1)
        ...
        BatteryAlloy = new Material.Builder(256, "battery_alloy")
                .ingot(1).fluid()
                .color(0x9C7CA0)
                .flags(EXT_METAL, GENERATE_LOW_YIELD_RECIPES)
        ...
        Brass = new Material.Builder(259, "brass")
                ...
                .flags(EXT2_METAL, MORTAR_GRINDABLE, GENERATE_LOW_YIELD_RECIPES)
        ...
        Bronze = new Material.Builder(260, "bronze")
                ...
                .flags(EXT2_METAL, MORTAR_GRINDABLE, GENERATE_ROTOR, GENERATE_FRAME, GENERATE_SMALL_GEAR, GENERATE_FOIL, GENERATE_GEAR, GENERATE_LOW_YIELD_RECIPES)
        ...
        Cupronickel = new Material.Builder(274, "cupronickel")
                ...
                .flags(EXT_METAL, GENERATE_SPRING, GENERATE_FINE_WIRE, GENERATE_LOW_YIELD_RECIPES)
        ...
        Diamond = new Material.Builder(276, "diamond")
                ...
                .flags(GENERATE_BOLT_SCREW, GENERATE_LENS, GENERATE_GEAR, NO_SMASHING, NO_SMELTING,
                        HIGH_SIFTER_OUTPUT, DISABLE_DECOMPOSITION, EXCLUDE_BLOCK_CRAFTING_BY_HAND_RECIPES, GENERATE_LOW_YIELD_RECIPES)
                .components(Carbon, 1)
        ...
        Electrum = new Material.Builder(277, "electrum")
                ...
                .flags(EXT2_METAL, MORTAR_GRINDABLE, GENERATE_FINE_WIRE, GENERATE_RING, GENERATE_LOW_YIELD_RECIPES)
        ...
        Emerald = new Material.Builder(278, "emerald")
                ...
                .flags(EXT_METAL, NO_SMASHING, NO_SMELTING, HIGH_SIFTER_OUTPUT, EXCLUDE_BLOCK_CRAFTING_BY_HAND_RECIPES, GENERATE_LENS, GENERATE_LOW_YIELD_RECIPES)
        ...
        Invar = new Material.Builder(287, "invar")
                ...
                .flags(EXT2_METAL, MORTAR_GRINDABLE, GENERATE_FRAME, GENERATE_GEAR, GENERATE_LOW_YIELD_RECIPES)
        ...
        Magnalium = new Material.Builder(290, "magnalium")
                .ingot().fluid()
                .color(0xC8BEFF)
                .flags(EXT2_METAL, GENERATE_LOW_YIELD_RECIPES)
        ...
        Obsidian = new Material.Builder(297, "obsidian")
                .dust(3)
                .color(0x503264)
                .flags(NO_SMASHING, EXCLUDE_BLOCK_CRAFTING_RECIPES, GENERATE_PLATE, GENERATE_LOW_YIELD_RECIPES)
        ...
        Ruby = new Material.Builder(311, "ruby")
                ...
                .flags(EXT_METAL, NO_SMASHING, NO_SMELTING, HIGH_SIFTER_OUTPUT, GENERATE_LENS, GENERATE_LOW_YIELD_RECIPES)
        ...
        Steel = new Material.Builder(324, "steel")
                ...
                .flags(EXT2_METAL, MORTAR_GRINDABLE, GENERATE_ROTOR, GENERATE_SMALL_GEAR, GENERATE_SPRING,
                        GENERATE_SPRING_SMALL, GENERATE_FRAME, DISABLE_DECOMPOSITION, GENERATE_FINE_WIRE, GENERATE_GEAR, GENERATE_LOW_YIELD_RECIPES)
                .components(Iron, 1)
        ...
        WroughtIron = new Material.Builder(335, "wrought_iron")
                ...
                .flags(EXT_METAL, GENERATE_GEAR, GENERATE_FOIL, MORTAR_GRINDABLE, GENERATE_RING, GENERATE_LONG_ROD, GENERATE_BOLT_SCREW, DISABLE_DECOMPOSITION, BLAST_FURNACE_CALCITE_TRIPLE, GENERATE_LOW_YIELD_RECIPES)
                .components(Iron, 1)
        ...
        NetherQuartz = new Material.Builder(339, "nether_quartz")
                ...
                .flags(GENERATE_PLATE, NO_SMELTING, CRYSTALLIZABLE, EXCLUDE_BLOCK_CRAFTING_BY_HAND_RECIPES, DISABLE_DECOMPOSITION, GENERATE_LOW_YIELD_RECIPES)
        ...
        IronMagnetic = new Material.Builder(395, "iron_magnetic")
                ...
                .flags(GENERATE_BOLT_SCREW, IS_MAGNETIC, GENERATE_LOW_YIELD_RECIPES)
                .components(Iron, 1)
                .ingotSmeltInto(Iron)
        ...
        ManganesePhosphide = new Material.Builder(424, "manganese_phosphide")
                ...
                .flags(DECOMPOSITION_BY_ELECTROLYZING, GENERATE_LOW_YIELD_RECIPES)
