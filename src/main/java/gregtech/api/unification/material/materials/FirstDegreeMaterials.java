...
public class FirstDegreeMaterials {
    ...
    public static void register() {
        ...
        Clay = new Material.Builder(270, "clay")
                .dust(1)
        ...
        DiamericiumTitanium = new Material.Builder(317, "diamericium_titanium")
                ...
                .blastTemp(10400, GasTier.HIGHER)
                .build();
