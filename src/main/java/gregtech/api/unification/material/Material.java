...
public class Material implements Comparable<Material> {
    ...
    public static class Builder {
        ...
        /**
         * Add a {@link CosmicProperty} to this Material.<br>
         ...
         * @param haloTexture the Halo Texture for a specific Material in the form of a String : Example "halo".<br>
         ...
         *                         All the locations for these are autogenerated and follow the same path as the MaterialIconSet the material uses: Example "gregtech:textures/items/material_sets/dull/dust_mask
        ...
        public Builder cosmic(boolean shouldDrawHalo, String haloTexture, String haloColour, int haloSize, boolean shouldDrawPulse, boolean shouldDrawCosmic, Float maskOpacity) {
        ...
        @Optional.Method(modid = Mods.Names.AVARITIA)
        public Builder cosmic(boolean shouldDrawHalo, String haloTexture, String haloColour, int haloSize, boolean shouldDrawPulse) {
            if (Avaritia.isModLoaded()) {
                properties.setProperty(PropertyKey.COSMIC,
                        new CosmicProperty(shouldDrawHalo, haloTexture, haloColour, haloSize, shouldDrawPulse));
            }
