...
public interface IteratorFactory<T> {
    ...
    Iterator<T> newIterator(INetGraph graph, IPredicateTestObject testObject, @Nullable SimulatorKey simulator, long queryTick);

    static void defaultPrepareRun(INetGraph graph, IPredicateTestObject testObject, @Nullable SimulatorKey simulator, long queryTick) {
