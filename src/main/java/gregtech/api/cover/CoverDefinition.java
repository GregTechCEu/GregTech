...
public class CoverDefinition {
    ...
    public static CoverDefinition getCoverById(ResourceLocation id) {
        return GregTechRegistries.getCoverRegistry().getObject(id);
    }

    public static CoverDefinition getCoverByNetworkId(int networkId) {
        return GregTechRegistries.getCoverRegistry().getObjectById(networkId);
    }

    public static int getNetworkIdForCover(CoverDefinition definition) {
        return GregTechRegistries.getCoverRegistry().getIDForObject(definition);
    }
