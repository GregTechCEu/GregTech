...
public class SimpleMachineProfile implements IMachineConfiguratorProfile {
    ...
    public ModularPanel createConfiguratorPanel(@NotNull PanelSyncManager panelSyncManager,
        ...
        var panel = GTGuis.createPanel("simple_machine_configurator", 200, 200);
                        ...
                        .key('B', buttonIndex -> new ButtonWidget<>()
                                ...
                                .onMousePressed(button -> {
                                    switch (buttonIndex) {
                                        ...
                                        default -> throw new IllegalArgumentException(
                                                "Clicked a button that doesn't exist!");
                                    }
                                }))
                        .build()
                        .marginLeft(4)));
    ...
    @NotNull
    private static IDrawable getSideOverlay(boolean isItem, boolean isFluid) {
        if (isItem && isFluid) {
