...
public class SingleRecipeRun implements RecipeRun {
    ...
    public SingleRecipeRun(RecipeView view, int recipeTier, int machineTier, long voltage, int duration) {
        this.view = view;
        ...
        itemsOut = view.rollItems(recipeTier, machineTier);
        fluidsOut = view.rollFluids(recipeTier, machineTier);
