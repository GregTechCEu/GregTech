...
public class ParallelLogic {
     ...
     */
    public static Tuple<RecipeBuilder<?>, Integer> multiplyRecipe(Recipe recipe, RecipeMap<?> recipeMap, IItemHandlerModifiable inputs, IMultipleTankHandler fluidInputs, int parallelAmount) {
