...
public interface ItemOutputProvider extends JEIDisplayControl {
    ...
    /**
     * Called to gather information about what this recipe can output. Used for JEI display, output bus fit
     * calculations, etc.
     *
