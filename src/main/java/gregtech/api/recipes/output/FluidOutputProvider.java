...
public interface FluidOutputProvider extends JEIDisplayControl {
    ...
    /**
     * Called to gather information about what this recipe can output. Used for JEI display, output hatch fit
     * calculations, etc.
     *
