...
public final class RecipeMaps {
    ...
    /**
     * Autogenerated based on material flags and blast properties
     */
    @ZenProperty
    public static final RecipeMap<BlastRecipeBuilder> FORGING_RECIPES = new RecipeMapBuilder<>("linear_forging_furnace",
            new BlastRecipeBuilder())
                    .itemInputs(3)
                    .itemOutputs(3)
                    .fluidInputs(2)
                    .fluidOutputs(1)
                    .sound(GTSoundEvents.FORGING)
                    .build();
