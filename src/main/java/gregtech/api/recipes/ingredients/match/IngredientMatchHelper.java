...
public final class IngredientMatchHelper {
     ...
     */
    public static @NotNull MatchCalculation<ItemStack> matchItems(@NotNull List<? extends Matcher<? super ItemStack>> matchers,
     ...
     */
    public static @NotNull MatchCalculation<FluidStack> matchFluids(@NotNull List<? extends Matcher<? super FluidStack>> matchers,
