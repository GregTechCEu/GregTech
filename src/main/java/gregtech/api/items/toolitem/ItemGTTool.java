...
public class ItemGTTool extends ItemTool implements IGTTool {
    ...
    protected ItemGTTool(String domain, String id, int tier, IGTToolDefinition toolStats, SoundEvent sound,
                         boolean playSoundOnBlockDestroy,
                         Set<String> toolClasses, String oreDict, List<String> secondaryOreDicts,
    ...
    public static class Builder extends ToolBuilder<ItemGTTool> {
        ...
        public Supplier<ItemGTTool> supply() {
            return () -> new ItemGTTool(domain, id, tier, toolStats, sound, playSoundOnBlockDestroy, toolClasses,
