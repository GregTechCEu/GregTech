...
public class ItemGTHoe extends ItemHoe implements IGTTool {
    ...
    protected ItemGTHoe(String domain, String id, int tier, IGTToolDefinition toolStats, SoundEvent sound,
    ...
    @NotNull
    @Override
    public EnumActionResult onItemUse(@NotNull EntityPlayer player, @NotNull World worldIn, @NotNull BlockPos pos,
    ...
    public static class Builder extends ToolBuilder<ItemGTHoe> {
        ...
        public Supplier<ItemGTHoe> supply() {
            return () -> new ItemGTHoe(domain, id, tier, toolStats, sound, playSoundOnBlockDestroy, toolClasses,
