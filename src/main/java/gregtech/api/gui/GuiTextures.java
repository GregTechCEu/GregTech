...
import gregtech.api.guiOld.resources.SteamTexture;
...
public class GuiTextures {
    ...
    public static final UITexture VANILLA_BACKGROUND = ModularUITextures.VANILLA_BACKGROUND;
    ...
    public static final UITexture CLIPBOARD_BACKGROUND = UITexture.fullImage("textures/gui/base/clipboard_background.png");
    public static final UITexture CLIPBOARD_PAPER_BACKGROUND = UITexture.fullImage("textures/gui/base/clipboard_paper_background.png");


    //public static final SteamTexture DISPLAY_STEAM = SteamTexture.fullImage("textures/gui/base/display_%s.png");
    public static final UITexture FLUID_SLOT = AdaptableUITexture.of(GTValues.MODID, "textures/gui/base/fluid_slot.png", 18, 18, 1);
    ...
    public static final UITexture SLOT = AdaptableUITexture.of(GTValues.MODID, "textures/gui/base/slot.png", 18, 18, 1);
    ...
    public static final UITexture BUTTON_CHUNK_MODE = UITexture.fullImage(GTValues.MODID, "textures/gui/widget/button_chunk_mode.png");
    ...
    public static final UITexture BUTTON_FLUID_OUTPUT = UITexture.fullImage(GTValues.MODID, "textures/gui/widget/button_fluid_output.png");
    public static final UITexture BUTTON_ITEM_OUTPUT = UITexture.fullImage(GTValues.MODID, "textures/gui/widget/button_item_output.png");
    ...
    public static final UITexture BUTTON_VOID_PARTIAL = UITexture.fullImage(GTValues.MODID, "textures/gui/widget/button_void_partial.png");
    ...
    public static final UITexture BUTTON_SILK_TOUCH_MODE = UITexture.fullImage(GTValues.MODID, "textures/gui/widget/button_silk_touch_mode.png");
    ...
    public static final UITexture CLIPBOARD_TEXT_BOX = AdaptableUITexture.of(GTValues.MODID, "textures/gui/widget/clipboard_text_box.png", 9, 18, 1);
    ...
    public static final UITexture VANILLA_BUTTON = UITexture.fullImage(GTValues.MODID, "textures/gui/widget/vanilla_button.png");
    ...
    //PRIMITIVE
    public static final UITexture PRIMITIVE_BACKGROUND = AdaptableUITexture.of(GTValues.MODID, "textures/gui/primitive/primitive_background.png", 176, 166, 3);
    public static final UITexture PRIMITIVE_SLOT = AdaptableUITexture.of(GTValues.MODID, "textures/gui/primitive/primitive_slot.png", 18, 18, 1);
    ...
    public static final UITexture MULTIBLOCK_CATEGORY = UITexture.fullImage(GTValues.MODID, "textures/gui/icon/coke_oven.png");
