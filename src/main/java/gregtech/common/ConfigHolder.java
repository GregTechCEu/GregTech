...
public class ConfigHolder {
    ...
    public static class MachineOptions {
        ...
        @Config.Comment({"Minimum distance of Long Distance Item Pipe Endpoints", "Default: 50"})
        public int ldItemPipeMinDistance = 50;
        
        @Config.Comment({"Minimum distance of Long Distance Fluid Pipe Endpoints", "Default: 50"})
