...
public class ConfigHolder {
    ...
    public static class MiscOptions {
        ...
        public boolean enableDimRadiation = true;
        ...
        public String[] dimensionAirHazards = new String[] { "default|", "0|", "-1|st100", "1|st100r100" };
        ...
        @Config.Comment({ "What items protect from which hazards. Non-helmets cannot block suffocation or toxicity." +
                ...
                "Suffocation - s | Toxic - t | Radiation - r" })
        @Config.RequiresWorldRestart
        public String[] itemHazardProtection = new String[] { "gregtech:gt_armor:10|s0t10",
