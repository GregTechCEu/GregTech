...
public class ConfigHolder {
    ...
    public static class MachineOptions {
        ...
        public boolean insufficientEnergySupplyWipesRecipeProgress = false;
        ...
        @Config.Comment("The default color to overlay onto machines. \n16777215 (0xFFFFFF in decimal) is no coloring (default), " +
                "and 13819135 (0xD2DCFF in decimal) is the classic blue from GT5. THIS IS SERVER SIDE!!!")
        public int defaultPaintingColor = 0xFFFFFF;

        @Config.Comment("The default color to overlay onto cable insulation. \n7829367 (0x777777 in decimal) is no coloring (default), " +
                "and 4210752 (0x404040 in decimal) is the classic black from GT5. THIS IS SERVER SIDE!!!")
    ...
    public static class RecipeOptions {
        ...
        @Config.Comment("Recipes for items like iron doors, trapdoors, buckets, cauldrons, hoppers, " +
                "and iron bars require iron plates, sticks, and more. Default: true")
