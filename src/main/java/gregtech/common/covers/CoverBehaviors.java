...
public class CoverBehaviors {
    ...
    public static void init() {
        ...
        registerBehavior(101, new ResourceLocation(GTValues.MODID, "fluid_voiding.advanced"), MetaItems.COVER_FLUID_VOIDING_REGULATOR, CoverFluidVoidingAdvanced::new);
        registerBehavior(102, new ResourceLocation(GTValues.MODID, "item_voiding"), MetaItems.COVER_ITEM_VOIDING, CoverItemVoiding::new);
        registerBehavior(103, new ResourceLocation(GTValues.MODID, "item_voiding.advanced"), MetaItems.COVER_ADVANCED_ITEM_VOIDING, CoverItemVoidingAdvanced::new);
