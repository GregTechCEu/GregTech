...
public class CoverDetectorMaintenance extends CoverDetectorBase implements ITickable {
    ...
    public CoverDetectorMaintenance(@NotNull CoverDefinition2 definition, @NotNull CoverableView coverableView, @NotNull EnumFacing attachedSide) {
    ...
    public boolean canAttach(@NotNull CoverableView coverable, @NotNull EnumFacing side) {
        return ConfigHolder.machines.enableMaintenance
                && coverable instanceof IMaintenance maintenance
