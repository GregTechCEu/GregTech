...
public class ItemNetWalker extends PipeNetWalker {
    ...
    public static List<ItemPipeNet.Inventory> createNetData(ItemPipeNet net, World world, BlockPos sourcePipe, EnumFacing faceToSourceHandler) {
    ...
    protected PipeNetWalker createSubWalker(PipeNet<?> net, World world, BlockPos nextPos, int walkedBlocks) {
        ItemNetWalker walker = new ItemNetWalker(net, world, nextPos, walkedBlocks, inventories, minProperties);
