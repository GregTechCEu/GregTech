...
public class MetaArmor extends ArmorMetaItem<ArmorMetaItem<?>.ArmorMetaValueItem> {
    ...
    public void registerSubItems() {
        MetaItems.NIGHTVISION_GOGGLES = addItem(1, "nightvision_goggles").setArmorLogic(new NightvisionGoggles(2, 80_000L * (long) Math.max(1, Math.pow(1, ConfigHolder.U.equipment.voltageTierNightVision - 1)), ConfigHolder.U.equipment.voltageTierNightVision, EntityEquipmentSlot.HEAD));
        ...
        MetaItems.ELECTRIC_JETPACK_ADVANCED = addItem(4, "advanced_electric_jetpack").setArmorLogic(new AdvancedJetpack(512, 6_400_000L * (long) Math.max(1, Math.pow(4, ConfigHolder.U.equipment.voltageTierAdvImpeller - 4)), ConfigHolder.U.equipment.voltageTierAdvImpeller)).setRarity(EnumRarity.RARE);
        ...
        MetaItems.NANO_CHESTPLATE_ADVANCED = addItem(30, "nms.advanced_chestplate").setArmorLogic(new AdvancedNanoMuscleSuite(energyPerUse, 12_800_000L * (long) Math.max(1, Math.pow(4, ConfigHolder.U.equipment.voltageTierAdvNanoSuit - 3)), ConfigHolder.U.equipment.voltageTierAdvNanoSuit)).setRarity(EnumRarity.RARE);
        ...
        MetaItems.QUANTUM_CHESTPLATE_ADVANCED = addItem(50, "qts.advanced_chestplate").setArmorLogic(new AdvancedQuarkTechSuite(32768, 1_000_000_000L * (long) Math.max(1, Math.pow(4, ConfigHolder.U.equipment.voltageTierAdvQuarkTech - 6)), ConfigHolder.U.equipment.voltageTierAdvQuarkTech)).setRarity(EnumRarity.EPIC);
    }
}
