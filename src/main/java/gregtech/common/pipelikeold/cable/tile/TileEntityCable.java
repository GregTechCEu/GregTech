...
import gregtech.common.pipelikeold.cable.net.EnergyNetHandler;
import gregtech.common.pipelikeold.cable.net.WorldEnergyNet;
...
public class TileEntityCable extends TileEntityMaterialPipeBase<Insulation, WireProperties, NetFlowEdge>
    ...
    public NodeLossResult applyHeat(int amount, boolean simulate) {
        double loss = 1;
        Consumer<PipeNetNode<?, ?, ?>> destructionResult = null;
