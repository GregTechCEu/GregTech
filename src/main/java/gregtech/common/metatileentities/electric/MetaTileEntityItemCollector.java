...
public class MetaTileEntityItemCollector extends TieredMetaTileEntity {
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
        tooltip.add(LocalizationUtils.format("gregtech.machine.item_collector.collect_range", maxItemSuckingRange, maxItemSuckingRange));
        tooltip.add(LocalizationUtils.format("gregtech.universal.tooltip.max_voltage_in", energyContainer.getInputVoltage(), GTValues.VNF[getTier()]));
        ...
        tooltip.add(LocalizationUtils.format("gregtech.machine.item_controller.tooltip.redstone"));
        tooltip.add(LocalizationUtils.format("gregtech.machine.item_controller.tooltip.consumption", getEnergyConsumedPerTick()));
    }
