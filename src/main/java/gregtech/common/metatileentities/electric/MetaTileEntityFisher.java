...
public class MetaTileEntityFisher extends TieredMetaTileEntity {
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
        tooltip.add(LocalizationUtils.format("gregtech.machine.fisher.tooltip"));
        tooltip.add(LocalizationUtils.format("gregtech.machine.fisher.speed", fishingTicks));
        tooltip.add(LocalizationUtils.format("gregtech.machine.fisher.requirement", (int) Math.sqrt(WATER_CHECK_SIZE), (int) Math.sqrt(WATER_CHECK_SIZE)));
