...
//
//            if (getOffsetTimer() % getSpeed() == 0 && !blockPos.isEmpty()) {
//                int a = 0;
...
//        return new MetaTileEntityLargeMiner(metaTileEntityId, getTier(), getMaterial(), getSpeed(), getMaxChunkRadius(), getDrillingFluidConsumePerTick(), getFortune());
//    }
//
//    @Override
