    ...
    protected void addDisplayText(List<ITextComponent> textList) {
        ...
        if (isStructureFormed()) {
            if (getInputFluidInventory() != null) {
                ...
                textList.add(new TextComponentTranslation("gregtech.multiblock.large_combustion_engine.lubricant_amount", TextFormattingUtil.formatIntPretty(lubricantAmount)));
                if (boostAllowed) {
                    if (!isExtreme) {
                        if (((LargeCombustionEngineWorkableHandler) recipeMapWorkable).isOxygenBoosted) {
                            ...
                            textList.add(new TextComponentTranslation("gregtech.multiblock.large_combustion_engine.oxygen_amount", TextFormattingUtil.formatIntPretty(oxygenAmount)));
                        ...
                        if (((LargeCombustionEngineWorkableHandler) recipeMapWorkable).isOxygenBoosted) {
                            ...
                            textList.add(new TextComponentTranslation("gregtech.multiblock.large_combustion_engine.liquid_oxygen_amount", TextFormattingUtil.formatIntPretty((liquidOxygenAmount))));
