...
public class MetaTileEntities {
    ...
    public static void init() {
        ...
        MACERATOR[2] = registerMetaTileEntity(67, new MetaTileEntityMacerator(gregtechId("macerator.hv"), RecipeMaps.MACERATOR_RECIPES, 3, Textures.MACERATOR_OVERLAY, 3));
        MACERATOR[3] = registerMetaTileEntity(68, new MetaTileEntityMacerator(gregtechId("macerator.ev"), RecipeMaps.MACERATOR_RECIPES, 3, Textures.MACERATOR_OVERLAY, 4));
        MACERATOR[4] = registerMetaTileEntity(69, new MetaTileEntityMacerator(gregtechId("macerator.iv"), RecipeMaps.MACERATOR_RECIPES, 3, Textures.MACERATOR_OVERLAY, 5));
        if (getMidTier("macerator")) {
            MACERATOR[5] = registerMetaTileEntity(70, new MetaTileEntityMacerator(gregtechId("macerator.luv"), RecipeMaps.MACERATOR_RECIPES, 3, Textures.MACERATOR_OVERLAY, 6));
            MACERATOR[6] = registerMetaTileEntity(71, new MetaTileEntityMacerator(gregtechId("macerator.zpm"), RecipeMaps.MACERATOR_RECIPES, 3, Textures.MACERATOR_OVERLAY, 7));
            MACERATOR[7] = registerMetaTileEntity(72, new MetaTileEntityMacerator(gregtechId("macerator.uv"), RecipeMaps.MACERATOR_RECIPES, 3, Textures.MACERATOR_OVERLAY, 8));
        }
        if (getHighTier("macerator")) {
            MACERATOR[8] = registerMetaTileEntity(73, new MetaTileEntityMacerator(gregtechId("macerator.uhv"), RecipeMaps.MACERATOR_RECIPES, 3, Textures.MACERATOR_OVERLAY, 9));
            MACERATOR[9] = registerMetaTileEntity(74, new MetaTileEntityMacerator(gregtechId("macerator.uev"), RecipeMaps.MACERATOR_RECIPES, 3, Textures.MACERATOR_OVERLAY, 10));
            MACERATOR[10] = registerMetaTileEntity(75, new MetaTileEntityMacerator(gregtechId("macerator.uiv"), RecipeMaps.MACERATOR_RECIPES, 3, Textures.MACERATOR_OVERLAY, 11));
            MACERATOR[11] = registerMetaTileEntity(76, new MetaTileEntityMacerator(gregtechId("macerator.umv"), RecipeMaps.MACERATOR_RECIPES, 3, Textures.MACERATOR_OVERLAY, 12));
            MACERATOR[12] = registerMetaTileEntity(77, new MetaTileEntityMacerator(gregtechId("macerator.uxv"), RecipeMaps.MACERATOR_RECIPES, 3, Textures.MACERATOR_OVERLAY, 13));
        }
        ...
        for (int i = 0; i < ITEM_IMPORT_BUS.length - 1; i++) {
            ...
            registerMetaTileEntity(1390 + i, ITEM_IMPORT_BUS[i]);
            registerMetaTileEntity(1405 + i, ITEM_EXPORT_BUS[i]);
            registerMetaTileEntity(1420 + i, FLUID_IMPORT_HATCH[i]);
            registerMetaTileEntity(1435 + i, FLUID_EXPORT_HATCH[i]);
        }
        ...
        registerMetaTileEntity(1390 + 9, ITEM_IMPORT_BUS[9]);
        registerMetaTileEntity(1405 + 9, ITEM_EXPORT_BUS[9]);
        registerMetaTileEntity(1420 + 9, FLUID_IMPORT_HATCH[9]);
        registerMetaTileEntity(1435 + 9, FLUID_EXPORT_HATCH[9]);
        ...
        for (int i = 0; i < endPos; i++) {
            ...
            registerMetaTileEntity(1450 + i, ENERGY_INPUT_HATCH[i]);
            registerMetaTileEntity(1465 + i, ENERGY_INPUT_HATCH_ADJUSTABLE[i]);
            registerMetaTileEntity(1480 + i, ENERGY_OUTPUT_HATCH[i]);
            registerMetaTileEntity(1495 + i, ENERGY_OUTPUT_HATCH_ADJUSTABLE[i]);
        }
        // MAX Hatches
        ...
        registerMetaTileEntity(1450 + ENERGY_INPUT_HATCH.length - 1, ENERGY_INPUT_HATCH[ENERGY_INPUT_HATCH.length - 1]);
        registerMetaTileEntity(1465 + ENERGY_INPUT_HATCH_ADJUSTABLE.length - 1, ENERGY_INPUT_HATCH_ADJUSTABLE[ENERGY_INPUT_HATCH_ADJUSTABLE.length - 1]);
        registerMetaTileEntity(1480 + ENERGY_INPUT_HATCH.length - 1, ENERGY_INPUT_HATCH[ENERGY_INPUT_HATCH.length - 1]);
        registerMetaTileEntity(1495 + ENERGY_OUTPUT_HATCH_ADJUSTABLE.length - 1, ENERGY_OUTPUT_HATCH_ADJUSTABLE[ENERGY_OUTPUT_HATCH_ADJUSTABLE.length - 1]);
        ...
        MAINTENANCE_HATCH[0] = registerMetaTileEntity(1654, new MetaTileEntityMaintenanceHatch(gregtechId("maintenance_hatch"), 1));
        MAINTENANCE_HATCH[1] = registerMetaTileEntity(1655, new MetaTileEntityMaintenanceHatch(gregtechId("maintenance_hatch_taping"), 3));
        MAINTENANCE_HATCH[2] = registerMetaTileEntity(1656, new MetaTileEntityMaintenanceHatch(gregtechId("maintenance_hatch_full_auto"), 6));
    ...
    private static <T extends MetaTileEntity> T registerMetaTileEntity(int id, T sampleMetaTileEntity) {
        GregTechRegistries.getMetaTileEntityRegistry().register(id, sampleMetaTileEntity.metaTileEntityId, sampleMetaTileEntity);
