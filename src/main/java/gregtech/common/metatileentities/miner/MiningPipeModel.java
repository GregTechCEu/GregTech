...
public final class MiningPipeModel {

    private static final Map<String, MiningPipeModel> MINING_PIPE_MODELS = new Object2ObjectOpenHashMap<>();
    ...
    @Nonnull
    public static MiningPipeModel register(@Nonnull String type) {
        return MINING_PIPE_MODELS.computeIfAbsent(type, MiningPipeModel::new);
    }
    ...
    private MiningPipeModel(@Nonnull String type) {
        this.type = type;
    }
    ...
    public static void onTextureStitch(TextureStitchEvent.Pre event) {
        for (MiningPipeModel miningPipe : MINING_PIPE_MODELS.values()) {
