...
public class BlockOreFactory extends AbstractBlockModelFactory {
    ...
    protected String fillSample(Block block, String blockStateSample) {
        return blockStateSample
                ...
                .replace("$MATERIAL_TEXTURE_NORMAL$", MaterialIconType.ore.getBlockPath(((BlockOre) block).material.getMaterialIconSet(), ((BlockOre) block).material.getProperty(PropertyKey.ORE).isEmissive()).toString());
    }
