...
public class MaterialInfoLoader {
    ...
    public static void init() {
        ...
        GregTechAPI.RECYCLING_MANAGER.registerRecyclingData(MetaTileEntities.ENERGY_INPUT_HATCH[3].getStackForm(), new RecyclingData(
                new MaterialStack(Materials.StainlessSteel, M * 8), // plate
        ...
        GregTechAPI.RECYCLING_MANAGER.registerRecyclingData(MetaTileEntities.ENERGY_INPUT_HATCH[4].getStackForm(), new RecyclingData(
                new MaterialStack(Materials.Titanium, M * 8), // plate
        ...
        GregTechAPI.RECYCLING_MANAGER.registerRecyclingData(MetaTileEntities.ENERGY_INPUT_HATCH[5].getStackForm(), new RecyclingData(
                new MaterialStack(Materials.TungstenSteel, M * 8), // plate
                new MaterialStack(Materials.Platinum, M), // single cable
        ...
        GregTechAPI.RECYCLING_MANAGER.registerRecyclingData(MetaTileEntities.ENERGY_OUTPUT_HATCH[3].getStackForm(), new RecyclingData(
                new MaterialStack(Materials.StainlessSteel, M * 8), // plate
        ...
        GregTechAPI.RECYCLING_MANAGER.registerRecyclingData(MetaTileEntities.ENERGY_OUTPUT_HATCH[4].getStackForm(), new RecyclingData(
                new MaterialStack(Materials.Titanium, M * 8), // plate
        ...
        GregTechAPI.RECYCLING_MANAGER.registerRecyclingData(MetaTileEntities.ENERGY_OUTPUT_HATCH[5].getStackForm(), new RecyclingData(
                new MaterialStack(Materials.TungstenSteel, M * 8), // plate
                new MaterialStack(Materials.Platinum, M), // single cable
        ...
        GregTechAPI.RECYCLING_MANAGER.registerRecyclingData(new ItemStack(Blocks.REDSTONE_TORCH, 1, W), new RecyclingData(
        ...
        if (ConfigHolder.recipes.hardRedstoneRecipes) {
            GregTechAPI.RECYCLING_MANAGER.registerRecyclingData(new ItemStack(Blocks.WOODEN_PRESSURE_PLATE, 1, W), new RecyclingData(
                    new MaterialStack(Materials.Wood, M), new MaterialStack(Materials.Iron, M / 2)));
            GregTechAPI.RECYCLING_MANAGER.registerRecyclingData(new ItemStack(Blocks.STONE_PRESSURE_PLATE, 1, W), new RecyclingData(
        ...
        if (ConfigHolder.recipes.hardMiscRecipes) {
            ...
            GregTechAPI.RECYCLING_MANAGER.registerRecyclingData(new ItemStack(Blocks.ENCHANTING_TABLE, 1, W), new RecyclingData(
                    new MaterialStack(Materials.Diamond, M * 4),
                    new MaterialStack(Materials.Obsidian, M * 3),
                    new MaterialStack(Materials.Paper, M * 9)));

            GregTechAPI.RECYCLING_MANAGER.registerRecyclingData(new ItemStack(Blocks.ENDER_CHEST, 1, W), new RecyclingData(
        ...
        GregTechAPI.RECYCLING_MANAGER.registerRecyclingData(new ItemStack(Blocks.TRAPPED_CHEST, 1, W), new RecyclingData(
                new MaterialStack(Materials.Wood, M * 8), new MaterialStack(Materials.Iron, M / 2))); // ring

        if (ConfigHolder.recipes.hardMiscRecipes) {
            GregTechAPI.RECYCLING_MANAGER.registerRecyclingData(new ItemStack(Blocks.NOTEBLOCK, 1, W), new RecyclingData(
        ...
        GregTechAPI.RECYCLING_MANAGER.registerRecyclingData(new ItemStack(Blocks.REDSTONE_LAMP, 1, W), new RecyclingData(
        ...
        GregTechAPI.RECYCLING_MANAGER.registerRecyclingData(new ItemStack(Blocks.STICKY_PISTON, 1, W), new RecyclingData(
                new MaterialStack(Materials.Stone, M * 4), new MaterialStack(Materials.Wood, M * 3)));
        if (ConfigHolder.recipes.hardRedstoneRecipes) {
            ...
            GregTechAPI.RECYCLING_MANAGER.registerRecyclingData(new ItemStack(Blocks.DISPENSER, 1, W), new RecyclingData(
