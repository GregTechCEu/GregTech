...
public class CircuitRecipes {
    ...
    private static void waferRecipes() {
        ...
        BLAST_RECIPES.recipeBuilder()
                ...
                .duration(9000).volts(VA[MV]).buildAndRegister();
        ...
        BLAST_RECIPES.recipeBuilder()
                ...
                .duration(12000).volts(VA[HV]).buildAndRegister();
        ...
        BLAST_RECIPES.recipeBuilder()
                ...
                .duration(15000).volts(VA[EV]).buildAndRegister();
        ...
        CUTTER_RECIPES.recipeBuilder()
                ...
                .cleanroom(CleanroomType.CLEANROOM)
                .duration(2400).volts(VA[IV]).buildAndRegister();

        // Wafer engraving
        LASER_ENGRAVER_RECIPES.recipeBuilder().duration(900).volts(VA[MV]).inputItem(SILICON_WAFER)
                .notConsumable(craftingLens, Color.Red).outputItem(INTEGRATED_LOGIC_CIRCUIT_WAFER).buildAndRegister();
        LASER_ENGRAVER_RECIPES.recipeBuilder().duration(500).volts(VA[HV]).inputItem(PHOSPHORUS_WAFER)
        ...
        LASER_ENGRAVER_RECIPES.recipeBuilder().duration(200).volts(VA[EV]).inputItem(NAQUADAH_WAFER)
                .notConsumable(craftingLens, Color.Red).outputItem(INTEGRATED_LOGIC_CIRCUIT_WAFER, 8)
                .cleanroom(CleanroomType.CLEANROOM).buildAndRegister();
        LASER_ENGRAVER_RECIPES.recipeBuilder().duration(50).volts(VA[IV]).inputItem(NEUTRONIUM_WAFER)
        ...
        LASER_ENGRAVER_RECIPES.recipeBuilder().duration(900).volts(VA[HV]).inputItem(PHOSPHORUS_WAFER)
                .notConsumable(craftingLens, Color.Gray).outputItem(NAND_MEMORY_CHIP_WAFER)
                .cleanroom(CleanroomType.CLEANROOM).buildAndRegister();
        LASER_ENGRAVER_RECIPES.recipeBuilder().duration(500).volts(VA[EV]).inputItem(NAQUADAH_WAFER)
                .notConsumable(craftingLens, Color.Gray).outputItem(NAND_MEMORY_CHIP_WAFER, 4)
                .cleanroom(CleanroomType.CLEANROOM).buildAndRegister();
        LASER_ENGRAVER_RECIPES.recipeBuilder().duration(200).volts(VA[IV]).inputItem(NEUTRONIUM_WAFER)
        ...
        LASER_ENGRAVER_RECIPES.recipeBuilder().duration(900).volts(VA[EV]).inputItem(NAQUADAH_WAFER)
                .notConsumable(craftingLens, Color.Purple).outputItem(ADVANCED_SYSTEM_ON_CHIP_WAFER)
                .cleanroom(CleanroomType.CLEANROOM).buildAndRegister();
        LASER_ENGRAVER_RECIPES.recipeBuilder().duration(500).volts(VA[IV]).inputItem(NEUTRONIUM_WAFER)
        ...
        LASER_ENGRAVER_RECIPES.recipeBuilder().duration(900).volts(VA[IV]).inputItem(NEUTRONIUM_WAFER)
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .cleanroom(CleanroomType.CLEANROOM)
                .duration(1200).volts(VA[EV]).buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .cleanroom(CleanroomType.CLEANROOM)
                .duration(900).volts(VA[EV]).buildAndRegister();
        ...
        // Wafer cutting
        CUTTER_RECIPES.recipeBuilder().duration(900).volts(VA[IV]).inputItem(HIGHLY_ADVANCED_SOC_WAFER)
                .outputItem(HIGHLY_ADVANCED_SOC, 6).cleanroom(CleanroomType.CLEANROOM).buildAndRegister();
        CUTTER_RECIPES.recipeBuilder().duration(900).volts(VA[EV]).inputItem(ADVANCED_SYSTEM_ON_CHIP_WAFER)
                .outputItem(ADVANCED_SYSTEM_ON_CHIP, 6).cleanroom(CleanroomType.CLEANROOM).buildAndRegister();
        CUTTER_RECIPES.recipeBuilder().duration(900).volts(VA[HV]).inputItem(SYSTEM_ON_CHIP_WAFER)
                .outputItem(SYSTEM_ON_CHIP, 6)
                .cleanroom(CleanroomType.CLEANROOM).buildAndRegister();
        CUTTER_RECIPES.recipeBuilder().duration(900).volts(64).inputItem(SIMPLE_SYSTEM_ON_CHIP_WAFER)
                .outputItem(SIMPLE_SYSTEM_ON_CHIP, 6).buildAndRegister();
        CUTTER_RECIPES.recipeBuilder().duration(900).volts(96).inputItem(RANDOM_ACCESS_MEMORY_WAFER)
                .outputItem(RANDOM_ACCESS_MEMORY, 32).buildAndRegister();
        CUTTER_RECIPES.recipeBuilder().duration(900).volts(VA[EV]).inputItem(QUBIT_CENTRAL_PROCESSING_UNIT_WAFER)
                .outputItem(QUBIT_CENTRAL_PROCESSING_UNIT, 4).cleanroom(CleanroomType.CLEANROOM).buildAndRegister();
        CUTTER_RECIPES.recipeBuilder().duration(900).volts(VA[MV]).inputItem(ULTRA_LOW_POWER_INTEGRATED_CIRCUIT_WAFER)
                .outputItem(ULTRA_LOW_POWER_INTEGRATED_CIRCUIT, 6).buildAndRegister();
        CUTTER_RECIPES.recipeBuilder().duration(900).volts(VA[HV]).inputItem(LOW_POWER_INTEGRATED_CIRCUIT_WAFER)
                .outputItem(LOW_POWER_INTEGRATED_CIRCUIT, 4).cleanroom(CleanroomType.CLEANROOM).buildAndRegister();
        CUTTER_RECIPES.recipeBuilder().duration(900).volts(VA[EV]).inputItem(POWER_INTEGRATED_CIRCUIT_WAFER)
                .outputItem(POWER_INTEGRATED_CIRCUIT, 4).cleanroom(CleanroomType.CLEANROOM).buildAndRegister();
        CUTTER_RECIPES.recipeBuilder().duration(900).volts(VA[IV]).inputItem(HIGH_POWER_INTEGRATED_CIRCUIT_WAFER)
                .outputItem(HIGH_POWER_INTEGRATED_CIRCUIT, 2).cleanroom(CleanroomType.CLEANROOM).buildAndRegister();
        CUTTER_RECIPES.recipeBuilder().duration(900).volts(VA[LuV]).inputItem(ULTRA_HIGH_POWER_INTEGRATED_CIRCUIT_WAFER)
                .outputItem(ULTRA_HIGH_POWER_INTEGRATED_CIRCUIT, 2).cleanroom(CleanroomType.CLEANROOM)
                .buildAndRegister();
        CUTTER_RECIPES.recipeBuilder().duration(900).volts(192).inputItem(NOR_MEMORY_CHIP_WAFER)
                .outputItem(NOR_MEMORY_CHIP, 16)
                .cleanroom(CleanroomType.CLEANROOM).buildAndRegister();
        CUTTER_RECIPES.recipeBuilder().duration(900).volts(192).inputItem(NAND_MEMORY_CHIP_WAFER)
                .outputItem(NAND_MEMORY_CHIP, 32)
                .cleanroom(CleanroomType.CLEANROOM).buildAndRegister();
        CUTTER_RECIPES.recipeBuilder().duration(900).volts(VA[MV]).inputItem(CENTRAL_PROCESSING_UNIT_WAFER)
                .outputItem(CENTRAL_PROCESSING_UNIT, 8).buildAndRegister();
        CUTTER_RECIPES.recipeBuilder().duration(900).volts(64).inputItem(INTEGRATED_LOGIC_CIRCUIT_WAFER)
                .outputItem(INTEGRATED_LOGIC_CIRCUIT, 8).buildAndRegister();
        CUTTER_RECIPES.recipeBuilder().duration(900).volts(VA[HV]).inputItem(NANO_CENTRAL_PROCESSING_UNIT_WAFER)
    ...
    private static void componentRecipes() {
        ...
        ALLOY_SMELTER_RECIPES.recipeBuilder()
                ...
                .duration(160).volts(16).buildAndRegister();

        FLUID_SOLIDFICATION_RECIPES.recipeBuilder()
                .fluidInputs(Glass.getFluid(L))
                .notConsumable(SHAPE_MOLD_BALL)
                .outputItem(GLASS_TUBE)
                .duration(200).volts(24).buildAndRegister();

        FORMING_PRESS_RECIPES.recipeBuilder()
                .inputItem(dust, Glass)
                .notConsumable(SHAPE_MOLD_BALL)
                .outputItem(GLASS_TUBE)
                .duration(80).volts(VA[ULV]).buildAndRegister();
        ...
        ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .duration(160).volts(6).buildAndRegister();
        ...
        ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .duration(320).volts(VA[MV]).buildAndRegister();
        ...
        ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .duration(160).volts(VA[MV]).buildAndRegister();
        ...
        ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .fluidInputs(Glass.getFluid(L))
                .outputItem(DIODE)
                .duration(400).volts(VA[LV]).buildAndRegister();
        ...
        ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .duration(160).volts(VA[HV]).buildAndRegister();
        ...
        ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .outputItem(ADVANCED_SMD_RESISTOR, 16).volts(3840).duration(160).buildAndRegister();
        ...
        ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .fluidInputs(Polybenzimidazole.getFluid(L * 2))
                .outputItem(ADVANCED_SMD_DIODE, 64).volts(3840).duration(640).buildAndRegister();
        ...
        ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .outputItem(ADVANCED_SMD_TRANSISTOR, 16).volts(3840).duration(160).buildAndRegister();
        ...
        ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .outputItem(ADVANCED_SMD_CAPACITOR, 16).volts(3840).duration(80).buildAndRegister();
        ...
        ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .fluidInputs(Polybenzimidazole.getFluid(L))
                .outputItem(ADVANCED_SMD_INDUCTOR, 16).volts(3840).duration(160).buildAndRegister();
        ...
        LASER_ENGRAVER_RECIPES.recipeBuilder()
                ...
                .cleanroom(CleanroomType.CLEANROOM)
                .duration(100).volts(10000).buildAndRegister();
        ...
        LASER_ENGRAVER_RECIPES.recipeBuilder()
                ...
                .cleanroom(CleanroomType.CLEANROOM)
                .duration(100).volts(40000).buildAndRegister();

        AUTOCLAVE_RECIPES.recipeBuilder()
                .inputItem(gemExquisite, Emerald)
                .fluidInputs(Europium.getFluid(L / 9)).outputItemRoll(RAW_CRYSTAL_CHIP, 1000, 2000)
                .cleanroom(CleanroomType.CLEANROOM)
                .duration(12000).volts(320).buildAndRegister();
        ...
        FORGE_HAMMER_RECIPES.recipeBuilder()
                ...
                .outputItem(RAW_CRYSTAL_CHIP_PART, 9).volts(VA[HV]).duration(100).buildAndRegister();
        ...
        AUTOCLAVE_RECIPES.recipeBuilder()
                .inputItem(RAW_CRYSTAL_CHIP_PART)
                .fluidInputs(Mutagen.getFluid(250)).outputItemRoll(RAW_CRYSTAL_CHIP, 8000, 250)
                .cleanroom(CleanroomType.CLEANROOM)
                .duration(12000).volts(VA[HV]).buildAndRegister();

        AUTOCLAVE_RECIPES.recipeBuilder()
                .inputItem(RAW_CRYSTAL_CHIP_PART)
                .fluidInputs(BacterialSludge.getFluid(250)).outputItemRoll(RAW_CRYSTAL_CHIP, 8000, 250)
                .cleanroom(CleanroomType.CLEANROOM)
                .duration(12000).volts(VA[HV]).buildAndRegister();
        ...
        BLAST_RECIPES.recipeBuilder()
                ...
                .duration(900).volts(VA[HV]).buildAndRegister();
    ...
    private static void boardRecipes() {
        ...
        CHEMICAL_RECIPES.recipeBuilder().volts(VA[LV]).duration(300)
        ...
        // Plastic Board
        CHEMICAL_RECIPES.recipeBuilder().duration(500).volts(10)
        ...
        CHEMICAL_RECIPES.recipeBuilder().duration(600).volts(VA[LV])
        ...
        CHEMICAL_RECIPES.recipeBuilder().duration(900).volts(VA[LV])
        ...
        CHEMICAL_BATH_RECIPES.recipeBuilder().duration(240).volts(16)
        ...
        EXTRUDER_RECIPES.recipeBuilder().duration(160).volts(96)
        ...
        CHEMICAL_RECIPES.recipeBuilder().duration(1200).volts(VA[LV])
        ...
        CHEMICAL_RECIPES.recipeBuilder().duration(500).volts(VA[HV])
        ...
        // Elite Circuit Board
        CHEMICAL_RECIPES.recipeBuilder().duration(1500).volts(VA[MV])
        ...
        FLUID_SOLIDFICATION_RECIPES.recipeBuilder().duration(160).volts(VA[HV])
                .notConsumable(SHAPE_MOLD_CYLINDER)
                .fluidInputs(Polytetrafluoroethylene.getFluid(L / 4))
                .outputItem(PETRI_DISH)
                .buildAndRegister();

        FLUID_SOLIDFICATION_RECIPES.recipeBuilder().duration(40).volts(VA[HV])
                .notConsumable(SHAPE_MOLD_CYLINDER)
                .fluidInputs(Polybenzimidazole.getFluid(L / 8))
                .outputItem(PETRI_DISH, 2)
                .buildAndRegister();

        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().duration(1200).volts(VA[LuV])
        ...
        CHEMICAL_RECIPES.recipeBuilder().duration(1800).volts(VA[HV])
    ...
    private static void circuitRecipes() {
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(16).duration(200)
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(16).duration(300)
        ...
        // MV
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(24).duration(400)
                .inputItem(GOOD_CIRCUIT_BOARD)
        ...
        // HV
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(VA[LV]).duration(800)
        ...
        // NAND Chip ULV
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(VA[MV]).duration(300)
                .inputItem(GOOD_CIRCUIT_BOARD)
        ...
        // Microprocessor LV
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(60).duration(200)
                .inputItem(PLASTIC_CIRCUIT_BOARD)
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(600).duration(50)
                .inputItem(PLASTIC_CIRCUIT_BOARD)
        ...
        // MV SoC
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(2400).duration(50)
                .inputItem(PLASTIC_CIRCUIT_BOARD)
                .inputItem(SYSTEM_ON_CHIP)
                .inputItem(wireFine, RedAlloy, 4)
        ...
        // HV
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(90).duration(400)
                .inputItem(PLASTIC_CIRCUIT_BOARD)
        ...
        // EV
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(VA[MV]).duration(400)
                .inputItem(PLASTIC_CIRCUIT_BOARD)
        ...
        // IV
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(VA[HV]).duration(800)
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(VA[HV]).duration(400)
                .inputItem(frameGt, Aluminium, 2)
                .inputItem(WORKSTATION_EV, 2)
        ...
        // HV
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(600).duration(200)
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(600).duration(100)
                .inputItem(ADVANCED_CIRCUIT_BOARD)
                .inputItem(NANO_CENTRAL_PROCESSING_UNIT)
        ...
        // HV SoC
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(9600).duration(50)
                .inputItem(ADVANCED_CIRCUIT_BOARD)
        ...
        // EV
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(600).duration(400)
                .inputItem(ADVANCED_CIRCUIT_BOARD)
        ...
        // LuV
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(VA[EV]).duration(800)
                .inputItem(frameGt, Aluminium, 2)
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(VA[EV]).duration(400)
                .inputItem(frameGt, Aluminium, 2)
                .inputItem(NANO_COMPUTER_IV, 2)
        ...
        // EV
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(2400).duration(200)
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(2400).duration(100)
                .inputItem(EXTREME_CIRCUIT_BOARD)
                .inputItem(QUBIT_CENTRAL_PROCESSING_UNIT)
                .inputItem(NANO_CENTRAL_PROCESSING_UNIT)
        ...
        // EV SoC
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(38400).duration(50)
                .inputItem(EXTREME_CIRCUIT_BOARD)
                .inputItem(ADVANCED_SYSTEM_ON_CHIP)
                .inputItem(wireFine, Platinum, 12)
        ...
        // IV
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(2400).duration(400)
                .inputItem(EXTREME_CIRCUIT_BOARD)
        ...
        // ZPM
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(VA[IV]).duration(800)
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(VA[IV]).duration(400)
                .inputItem(frameGt, HSSG, 2)
                .inputItem(QUANTUM_COMPUTER_LUV, 2)
        ...
        // IV
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(9600).duration(200)
        ...
        // IV SoC
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(86000).duration(100)
                .inputItem(ELITE_CIRCUIT_BOARD)
        ...
        // LuV
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(9600).duration(400)
                .inputItem(ELITE_CIRCUIT_BOARD)
        ...
        // UV
        ASSEMBLY_LINE_RECIPES.recipeBuilder().volts(VA[LuV]).duration(800)
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(80000).duration(600)
        ...
        // LuV
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(38400).duration(200)
        ...
        // SoC LuV
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(150000).duration(100)
                .inputItem(NEURO_PROCESSOR)
        ...
        // ZPM
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().volts(38400).duration(400)
                .inputItem(WETWARE_CIRCUIT_BOARD)
        ...
        // UV
        ASSEMBLY_LINE_RECIPES.recipeBuilder().volts(38400).duration(400)
                .inputItem(WETWARE_CIRCUIT_BOARD)
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .stationResearch(b -> b
                        ...
                        .CWUt(96)
                        .EUt(VA[UV]))
                .volts(300000).duration(2000).buildAndRegister();
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .solderMultiplier(2)
                .cleanroom(CleanroomType.CLEANROOM)
                .duration(400).volts(1200).buildAndRegister();
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .solderMultiplier(2)
                .cleanroom(CleanroomType.CLEANROOM)
                .duration(400).volts(9600).buildAndRegister();
        ...
        CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .duration(400).volts(38400).buildAndRegister();
    }
}
