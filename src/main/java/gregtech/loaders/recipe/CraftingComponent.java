...
public class CraftingComponent {
    ...
    public static void initializeComponents() {
        ...
        PLATE = new Component(Stream.of(new Object[][]{
                ...
                {6, new UnificationEntry(OrePrefix.plate, Materials.Rhodallium)},
        ...
        DOUBLE_PLATE = new Component(Stream.of(new Object[][]{
                ...
                {6, new UnificationEntry(OrePrefix.plateDouble, Materials.Rhodallium)},
        ...
        ROTOR = new Component(Stream.of(new Object[][]{
                ...
                {6, new UnificationEntry(OrePrefix.rotor, Materials.Rhodallium)},
