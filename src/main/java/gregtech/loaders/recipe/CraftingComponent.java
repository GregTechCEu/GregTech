...
public class CraftingComponent {
    ...
    public static void initializeComponents() {
        ...
        LOW_CIRCUIT = new Component.Builder()
                .entry(0, OrePrefix.gem, Materials.Diamond)
                .entry(1, OrePrefix.circuit, MarkerMaterials.Tier.ULV)
                .entry(2, OrePrefix.circuit, MarkerMaterials.Tier.LV)
                .entry(3, OrePrefix.circuit, MarkerMaterials.Tier.MV)
                .entry(4, OrePrefix.circuit, MarkerMaterials.Tier.HV)
                .entry(5, OrePrefix.circuit, MarkerMaterials.Tier.EV)
                .entry(6, OrePrefix.circuit, MarkerMaterials.Tier.IV)
                .entry(7, OrePrefix.circuit, MarkerMaterials.Tier.LuV)
                .entry(8, OrePrefix.circuit, MarkerMaterials.Tier.ZPM)
                .entry(9, OrePrefix.circuit, MarkerMaterials.Tier.UV)
                .entry(10, OrePrefix.circuit, MarkerMaterials.Tier.UHV)
                .entry(11, OrePrefix.circuit, MarkerMaterials.Tier.UEV)
                .entry(12, OrePrefix.circuit, MarkerMaterials.Tier.UIV)
                .entry(13, OrePrefix.circuit, MarkerMaterials.Tier.UXV)
                .build();
