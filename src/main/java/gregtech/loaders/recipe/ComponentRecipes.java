...
public class ComponentRecipes {
    ...
    public static void register() {
        ...
        //Motors Start--------------------------------------------------------------------------------------------------
        if (GTRecipeLoaders.MOTORS.shouldRegister()) {
        ...
        if (GTRecipeLoaders.MOTORS_HIGH.shouldRegister()) {
        ...
        for (Map.Entry<String, Material> materialEntry : rubberMaterials.entrySet()) {
            ...
            if (GTRecipeLoaders.CONVEYORS.shouldRegister()) {
            ...
            //Pumps Start---------------------------------------------------------------------------------------------------
            if (GTRecipeLoaders.PUMPS.shouldRegister()) {
        ...
        if (GTRecipeLoaders.CONVEYORS_HIGH.shouldRegister()) {
            ASSEMBLY_LINE_RECIPES.recipeBuilder()
        ...
        if (GTRecipeLoaders.PUMPS_HIGH.shouldRegister()) {
            ASSEMBLY_LINE_RECIPES.recipeBuilder()
        ...
        if (GTRecipeLoaders.FLUID_REGULATORS.shouldRegister()) {
            ASSEMBLER_RECIPES.recipeBuilder()
        ...
        //Pistons Start-------------------------------------------------------------------------------------------------
        if (GTRecipeLoaders.PISTONS.shouldRegister()) {
        ...
        if (GTRecipeLoaders.PISTONS_HIGH.shouldRegister()) {
            ASSEMBLY_LINE_RECIPES.recipeBuilder()
                    .input(ELECTRIC_MOTOR_LuV)
                    .input(plate, HSSS, 4)
                    .input(ring, HSSS, 4)
        ...
        //Robot Arms Start ---------------------------------------------------------------------------------------------
        if (GTRecipeLoaders.ROBOT_ARMS.shouldRegister()) {
        ...
        if (GTRecipeLoaders.ROBOT_ARMS_HIGH.shouldRegister()) {
            ASSEMBLY_LINE_RECIPES.recipeBuilder()
        ...
        if (GTRecipeLoaders.FIELD_GENERATORS.shouldRegister()) {
        ...
        if (GTRecipeLoaders.FIELD_GENERATORS_HIGH.shouldRegister()) {
            ASSEMBLY_LINE_RECIPES.recipeBuilder()
                    .input(frameGt, HSSS)
                    .input(plate, HSSS, 6)
                    .input(QUANTUM_STAR)
        ...
        //Sensors Start-------------------------------------------------------------------------------------------------
        if (GTRecipeLoaders.SENSORS.shouldRegister()) {
        ...
        if (GTRecipeLoaders.SENSORS_HIGH.shouldRegister()) {
            ASSEMBLY_LINE_RECIPES.recipeBuilder()
                    .input(frameGt, HSSS)
                    .input(ELECTRIC_MOTOR_LuV)
        ...
        //Emitters Start------------------------------------------------------------------------------------------------
        if (GTRecipeLoaders.EMITTERS.shouldRegister()) {
        ...
        if (GTRecipeLoaders.EMITTERS_HIGH.shouldRegister()) {
            ASSEMBLY_LINE_RECIPES.recipeBuilder()
                    .input(frameGt, HSSS)
                    .input(ELECTRIC_MOTOR_LuV)
