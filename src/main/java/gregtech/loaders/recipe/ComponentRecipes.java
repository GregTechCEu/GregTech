    ...
    public static void register() {
        ...
        if (!Loader.isModLoaded(GTQT_CORE)) {
            ...
            ModHandler.addShapedRecipe(true, "electric_motor_lv_iron", ELECTRIC_MOTOR_LV.getStackForm(), "CWR", "WMW",
                    "RWC", 'C', new UnificationEntry(cableGtSingle, Tin), 'W',
            ...
            ModHandler.addShapedRecipe(true, "electric_motor_mv", ELECTRIC_MOTOR_MV.getStackForm(), "CWR", "WMW", "RWC",
                    'C', new UnificationEntry(cableGtSingle, Copper), 'W',
                    new UnificationEntry(wireGtDouble, Cupronickel),
            ...
            ModHandler.addShapedRecipe(true, "electric_motor_ev", ELECTRIC_MOTOR_EV.getStackForm(), "CWR", "WMW", "RWC",
                    'C', new UnificationEntry(cableGtDouble, Aluminium), 'W',
                    new UnificationEntry(wireGtDouble, Kanthal),
            ...
            ModHandler.addShapedRecipe(true, "electric_motor_iv", ELECTRIC_MOTOR_IV.getStackForm(), "CWR", "WMW", "RWC",
                    'C', new UnificationEntry(cableGtDouble, Tungsten), 'W',
                    new UnificationEntry(wireGtDouble, Graphene),
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(MolybdeniteLubricant.getFluid(1000))
        ...
        for (Map.Entry<String, Material> materialEntry : rubberMaterials.entrySet()) {
            ...
            if (!Loader.isModLoaded(GTQT_CORE)) {
                ...
                ModHandler.addShapedRecipe(material.equals(Rubber), String.format("electric_pump_lv_%s", name),
                        ELECTRIC_PUMP_LV.getStackForm(), "SXR", "dPw", "RMC", 'S', new UnificationEntry(screw, Tin),
                        'X',
                ...
                ModHandler.addShapedRecipe(material.equals(Rubber), String.format("electric_pump_mv_%s", name),
                        ELECTRIC_PUMP_MV.getStackForm(), "SXR", "dPw", "RMC", 'S', new UnificationEntry(screw, Bronze),
                        'X',
                ...
                ModHandler.addShapedRecipe(material.equals(Rubber), String.format("electric_pump_hv_%s", name),
                        ELECTRIC_PUMP_HV.getStackForm(), "SXR", "dPw", "RMC", 'S', new UnificationEntry(screw, Steel),
                        'X',
                        new UnificationEntry(rotor, Steel), 'P', new UnificationEntry(pipeNormalFluid, StainlessSteel),
                        'R',
                ...
                ModHandler.addShapedRecipe(material.equals(Rubber), String.format("electric_pump_ev_%s", name),
                        ...
                        new UnificationEntry(screw, StainlessSteel), 'X', new UnificationEntry(rotor, StainlessSteel),
                        'P',
                ...
                if (!material.equals(Rubber))
                    ModHandler.addShapedRecipe(material.equals(SiliconeRubber),
                            String.format("electric_pump_iv_%s", name),
                            ...
                            new UnificationEntry(ring, material), 'C', new UnificationEntry(cableGtSingle, Tungsten),
                            'M',
                            ELECTRIC_MOTOR_IV.getStackForm());
        ...
        // Start-------------------------------------------------------------------------------------------------
        if (!Loader.isModLoaded(GTQT_CORE)) {
            ModHandler.addShapedRecipe(true, "electric_piston_lv", ELECTRIC_PISTON_LV.getStackForm(), "PPP", "CRR",
                    "CMG",
                    ...
                    ELECTRIC_MOTOR_LV.getStackForm());
            ModHandler.addShapedRecipe(true, "electric_piston_mv", ELECTRIC_PISTON_MV.getStackForm(), "PPP", "CRR",
                    "CMG",
                    ...
                    ELECTRIC_MOTOR_MV.getStackForm());
            ModHandler.addShapedRecipe(true, "electric_piston_hv", ELECTRIC_PISTON_HV.getStackForm(), "PPP", "CRR",
                    "CMG",
                    'P', new UnificationEntry(plate, StainlessSteel), 'C', new UnificationEntry(cableGtSingle, Gold),
                    'R',
                    new UnificationEntry(stick, StainlessSteel), 'G', new UnificationEntry(gearSmall, StainlessSteel),
                    'M',
                    ELECTRIC_MOTOR_HV.getStackForm());
            ModHandler.addShapedRecipe(true, "electric_piston_ev", ELECTRIC_PISTON_EV.getStackForm(), "PPP", "CRR",
                    "CMG",
                    'P', new UnificationEntry(plate, Titanium), 'C', new UnificationEntry(cableGtSingle, Aluminium),
                    'R',
                    new UnificationEntry(stick, Titanium), 'G', new UnificationEntry(gearSmall, Titanium), 'M',
                    ELECTRIC_MOTOR_EV.getStackForm());
            ModHandler.addShapedRecipe(true, "electric_piston_iv", ELECTRIC_PISTON_IV.getStackForm(), "PPP", "CRR",
                    "CMG",
                    'P', new UnificationEntry(plate, TungstenSteel), 'C', new UnificationEntry(cableGtSingle, Tungsten),
                    'R', new UnificationEntry(stick, TungstenSteel), 'G',
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .fluidInputs(HighGradeSolderingAlloy.getFluid(L * 12))
                .fluidInputs(MolybdeniteLubricant.getFluid(1000))
                .fluidInputs(Naquadria.getFluid(L * 4))
                .output(ROBOT_ARM_UV)
                .stationResearch(b -> b
        ...
        // ---------------------------------------------------------------------------------------
        if (!Loader.isModLoaded(GTQT_CORE)) {
            ModHandler.addShapedRecipe(true, "field_generator_lv", FIELD_GENERATOR_LV.getStackForm(), "WPW", "XGX",
                    "WPW",
                    'W', new UnificationEntry(wireGtQuadruple, ManganesePhosphide), 'P',
                    new UnificationEntry(plate, Steel),
                    'G', new UnificationEntry(gem, EnderPearl), 'X', new UnificationEntry(circuit, Tier.LV));
            ModHandler.addShapedRecipe(true, "field_generator_mv", FIELD_GENERATOR_MV.getStackForm(), "WPW", "XGX",
                    "WPW",
                    ...
                    new UnificationEntry(circuit, Tier.MV));
            ModHandler.addShapedRecipe(true, "field_generator_hv", FIELD_GENERATOR_HV.getStackForm(), "WPW", "XGX",
                    "WPW",
                    ...
                    new UnificationEntry(circuit, Tier.HV));
            ModHandler.addShapedRecipe(true, "field_generator_ev", FIELD_GENERATOR_EV.getStackForm(), "WPW", "XGX",
                    "WPW",
                    ...
                    new UnificationEntry(circuit, Tier.EV));
            ModHandler.addShapedRecipe(true, "field_generator_iv", FIELD_GENERATOR_IV.getStackForm(), "WPW", "XGX",
                    "WPW",
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .input(wireFine, IndiumTinBariumTitaniumCuprate, 64)
                .input(cableGtSingle, NiobiumTitanium, 4)
                .fluidInputs(MolybdeniteLubricant.getFluid(L * 4))
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .input(wireFine, UraniumRhodiumDinaquadide, 64)
                .input(cableGtSingle, VanadiumGallium, 4)
                .fluidInputs(MolybdeniteLubricant.getFluid(L * 8))
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .input(wireFine, EnrichedNaquadahTriniumEuropiumDuranide, 64)
                .input(cableGtSingle, YttriumBariumCuprate, 4)
                .fluidInputs(MolybdeniteLubricant.getFluid(L * 12))
                .fluidInputs(Naquadria.getFluid(L * 4))
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .input(cableGtSingle, NiobiumTitanium, 4)
                .fluidInputs(MolybdeniteLubricant.getFluid(L * 2))
                .output(SENSOR_LuV)
                .scannerResearch(b -> b
