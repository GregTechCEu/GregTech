...
public class PolymerRecipes {
    ...
    private static void polyethyleneProcess() {
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .duration(1200).volts(VA[MV]).buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .duration(400).volts(200).buildAndRegister();
    ...
    private static void ptfeProcess() {
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .duration(80).volts(VA[LV]).buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .duration(480).volts(240).buildAndRegister();
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder()
                ...
                .duration(540).volts(VA[IV]).buildAndRegister();
    ...
    private static void epoxyProcess() {
        CHEMICAL_RECIPES.recipeBuilder()
                .inputItem(dustTiny, SodiumHydroxide)
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder()
                .inputItem(dust, SodiumHydroxide)
                ...
                .duration(5400).volts(VA[LV]).buildAndRegister();
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder()
                ...
                .fluidOutputs(SaltWater.getFluid(1000))
                .duration(640).volts(VA[LV]).buildAndRegister();
    ...
    private static void styreneButadieneProcess() {
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .outputItem(dust, RawStyreneButadieneRubber, 27)
                .duration(480).volts(240).buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .outputItem(dust, RawStyreneButadieneRubber, 41)
                .duration(480).volts(240).buildAndRegister();

        CHEMICAL_RECIPES.recipeBuilder()
                .inputItem(dust, RawStyreneButadieneRubber, 9)
    ...
    private static void polybenzimidazoleProcess() {
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder().volts(VA[IV]).duration(100)
        ...
        CHEMICAL_RECIPES.recipeBuilder().volts(VA[EV]).duration(200)
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder().volts(VA[EV]).duration(1800)
        ...
        CHEMICAL_RECIPES.recipeBuilder().volts(VA[HV]).duration(100)
        ...
        CHEMICAL_RECIPES.recipeBuilder().volts(VA[LV]).duration(240)
                .fluidInputs(Chlorine.getFluid(2000))
                .fluidInputs(Benzene.getFluid(1000))
                .circuitMeta(1)
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder().volts(VA[EV]).duration(100)
                .inputItem(dustTiny, PotassiumDichromate)
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder().volts(VA[EV]).duration(900)
                .inputItem(dust, PotassiumDichromate)
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder().volts(VA[LV]).duration(125)
                .fluidInputs(Naphthalene.getFluid(2000))
                .fluidInputs(SulfuricAcid.getFluid(1000))
                .inputItem(dustTiny, Potassium)
                .fluidOutputs(PhthalicAcid.getFluid(2500))
                .fluidOutputs(HydrogenSulfide.getFluid(1000))
                .buildAndRegister();

        LARGE_CHEMICAL_RECIPES.recipeBuilder().volts(VA[LV]).duration(1125)
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder().volts(VA[MV]).duration(4000)
                .fluidInputs(Methane.getFluid(2000))
                .fluidInputs(Benzene.getFluid(1000))
                .circuitMeta(1)
        ...
        CHEMICAL_RECIPES.recipeBuilder().volts(VA[HV]).duration(100)
                .inputItem(dust, Saltpeter, 10)
                .inputItem(dust, ChromiumTrioxide, 8)
                .outputItem(dust, PotassiumDichromate, 11)
                .fluidOutputs(NitrogenDioxide.getFluid(2000))
                .buildAndRegister();

        CHEMICAL_RECIPES.recipeBuilder().volts(60).duration(100)
                .inputItem(dust, Chrome)
                .fluidInputs(Oxygen.getFluid(3000))
                .outputItem(dust, ChromiumTrioxide, 4)
                .buildAndRegister();
    }
    ...
    public static void polycaprolactamProcess() {
        ...
        CHEMICAL_RECIPES.recipeBuilder().volts(VA[MV]).duration(100)
                .fluidInputs(Cyclohexane.getFluid(1000))
                .fluidInputs(NitrosylChloride.getFluid(1000))
                .outputItem(dust, CyclohexanoneOxime, 19)
                .fluidOutputs(HydrochloricAcid.getFluid(1000))
                .buildAndRegister();

        CHEMICAL_RECIPES.recipeBuilder().volts(VA[HV]).duration(200)
                .inputItem(dust, CyclohexanoneOxime, 19)
                .fluidInputs(SulfuricAcid.getFluid(1000))
                .outputItem(dust, Caprolactam, 19)
                .fluidOutputs(DilutedSulfuricAcid.getFluid(1000))
                .buildAndRegister();

        BLAST_RECIPES.recipeBuilder().volts(VA[MV]).duration(150).blastFurnaceTemp(533)
                .inputItem(dust, Caprolactam, 1)
                .fluidInputs(Nitrogen.getFluid(1000))
                .outputItem(ingot, Polycaprolactam, 1)
                .buildAndRegister();
    }
}
