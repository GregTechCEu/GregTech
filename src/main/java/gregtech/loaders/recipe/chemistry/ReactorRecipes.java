...
public class ReactorRecipes {
    ...
    public static void init() {
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .fluidOutputs(Methane.getFluid(1000))
                .duration(3500).volts(VA[LV]).buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .duration(240).volts(360).buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .duration(240).volts(96).buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .duration(180).volts(VA[LV]).buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .circuitMeta(1)
                .fluidOutputs(DissolvedCalciumAcetate.getFluid(1000))
                .duration(400).volts(380).buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .duration(120).volts(96).buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .fluidInputs(Oxygen.getFluid(1000))
                .fluidOutputs(Methanol.getFluid(1000))
                .duration(320).volts(96).buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .duration(600).volts(VA[ULV]).buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .fluidOutputs(HydrochloricAcid.getFluid(1000))
                .duration(960).volts(VA[HV]).buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .duration(1040).volts(VA[HV]).buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .duration(1920).volts(VA[LV]).buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .fluidInputs(Methanol.getFluid(1000))
                .fluidOutputs(AceticAcid.getFluid(1000))
                .duration(300).volts(VA[LV]).buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .duration(200).volts(600).buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .fluidInputs(Oxygen.getFluid(1000)).outputItemRoll(dust, Ash, 1111, 0)
                .fluidOutputs(CarbonMonoxide.getFluid(1000))
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .duration(800).volts(VA[ULV]).buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                .circuitMeta(2)
                .inputItem(gem, Charcoal)
                .fluidInputs(Oxygen.getFluid(2000)).outputItemRoll(dust, Ash, 1111, 0)
                .fluidOutputs(CarbonDioxide.getFluid(1000))
                .duration(80).volts(VA[ULV]).buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .fluidOutputs(CarbonDioxide.getFluid(1000))
                .duration(150).volts(VA[HV]).buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .duration(140).volts(192).buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .duration(500).volts(VA[LV]).buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .duration(600).volts(16).buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .fluidOutputs(AceticAcid.getFluid(1000))
                .fluidOutputs(Methanol.getFluid(1000))
                .duration(264).volts(60).buildAndRegister();
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder()
                ...
                .duration(4000).volts(VA[HV]).buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .duration(160).volts(4).buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .fluidOutputs(Methane.getFluid(1000))
                .duration(200).volts(VH[HV]).buildAndRegister();
