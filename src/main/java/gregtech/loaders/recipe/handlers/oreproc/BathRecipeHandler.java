...
public class BathRecipeHandler {
    ...
    public static void bathBlueVitriol(Material material) {
    ...
    public static void bathGreenVitriol(Material material) {
        CHEMICAL_BATH_RECIPES.recipeBuilder()
                .input(crushedRefined, material)
                .fluidInputs(SulfuricAcid.getFluid(500))
                .output(dust, material, 2)
    ...
    public static void bathRedVitriol(Material material) {
        CHEMICAL_BATH_RECIPES.recipeBuilder()
                .input(crushedRefined, material)
                .fluidInputs(SulfuricAcid.getFluid(500))
                .output(dust, material, 2)
    ...
    public static void bathPinkVitriol(Material material) {
        CHEMICAL_BATH_RECIPES.recipeBuilder()
                .input(crushedRefined, material)
                .fluidInputs(SulfuricAcid.getFluid(500))
                .output(dust, material, 2)
    ...
    public static void bathCyanVitriol(Material material) {
        CHEMICAL_BATH_RECIPES.recipeBuilder()
                .input(crushedRefined, material)
                .fluidInputs(SulfuricAcid.getFluid(500))
                .output(dust, material, 2)
    ...
    public static void bathWhiteVitriol(Material material) {
        CHEMICAL_BATH_RECIPES.recipeBuilder()
                .input(crushedRefined, material)
                .fluidInputs(SulfuricAcid.getFluid(500))
                .output(dust, material, 2)
    ...
    public static void bathGrayVitriol(Material material) {
        CHEMICAL_BATH_RECIPES.recipeBuilder()
                .input(crushedRefined, material)
                .fluidInputs(SulfuricAcid.getFluid(500))
                .output(dust, material, 2)
    ...
    public static void bathClayVitriol(Material material) {
        CHEMICAL_BATH_RECIPES.recipeBuilder()
                .input(crushedRefined, material)
