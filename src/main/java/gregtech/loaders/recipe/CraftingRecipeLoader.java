...
public class CraftingRecipeLoader {
    ...
    private static void loadCraftingRecipes() {
        ...
        ModHandler.addShapedRecipe("armor/electric_jetpack", MetaItems.ELECTRIC_JETPACK.getStackForm(), "xCd", "MBM", "RIR", 'C', new UnificationEntry(OrePrefix.circuit, Tier.Advanced), 'M', MetaItems.ELECTRIC_MOTOR_MV.getStackForm(), 'B', MetaItems.BATTERY_MV_LITHIUM.getStackForm(), 'R', new UnificationEntry(OrePrefix.rotor, Steel), 'I', new UnificationEntry(OrePrefix.wireGtQuadruple, AnnealedCopper));
        ModHandler.addShapedRecipe("armor/electric_jetpack_advanced", MetaItems.ELECTRIC_JETPACK_ADVANCED.getStackForm(), "xJd", "TBT", "WCW", 'J', MetaItems.ELECTRIC_JETPACK.getStackForm(), 'T', MetaItems.IMPELLER_HV.getStackForm(), 'B', MetaItems.BATTERY_HV_LITHIUM.getStackForm(), 'W', new UnificationEntry(OrePrefix.wireGtQuadruple, Gold), 'C', new UnificationEntry(OrePrefix.circuit, Tier.Advanced));
