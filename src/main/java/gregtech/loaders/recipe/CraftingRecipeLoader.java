...
public class CraftingRecipeLoader {
    ...
    private static void loadCraftingRecipes() {
        ...
        ModHandler.addShapedRecipe("nano_saber", MetaItems.NANO_SABER.getStackForm(), "PIC", "PIC", "XEX", 'P', new UnificationEntry(OrePrefix.plate, Materials.Platinum), 'I', new UnificationEntry(OrePrefix.plate, Ruridit), 'C', MetaItems.CARBON_FIBER_PLATE.getStackForm(), 'X', new UnificationEntry(OrePrefix.circuit, Tier.Extreme), 'E', MetaItems.ENERGIUM_CRYSTAL.getStackForm());
        ...
        ModHandler.addShapedRecipe("armor/electric_jetpack", MetaItems.ELECTRIC_JETPACK.getStackForm(), "xCs", "MBM", "RIR", 'C', new UnificationEntry(OrePrefix.circuit, Tier.Advanced), 'M', MetaItems.ELECTRIC_MOTOR_MV.getStackForm(), 'B', MetaItems.BATTERY_MV_LITHIUM.getStackForm(), 'R', new UnificationEntry(OrePrefix.rotor, Steel), 'I', new UnificationEntry(OrePrefix.wireGtQuadruple, AnnealedCopper));
        ModHandler.addShapedRecipe("armor/electric_jetpack_advanced", MetaItems.ELECTRIC_JETPACK_ADVANCED.getStackForm(), "xJs", "TBT", "WCW", 'J', MetaItems.ELECTRIC_JETPACK.getStackForm(), 'T', MetaItems.IMPELLER_HV.getStackForm(), 'B', MetaItems.BATTERY_HV_LITHIUM.getStackForm(), 'W', new UnificationEntry(OrePrefix.wireGtQuadruple, Gold), 'C', new UnificationEntry(OrePrefix.circuit, Tier.Advanced));
        ModHandler.addShapedRecipe("armor/nano_helmet", MetaItems.NANO_HELMET.getStackForm(), "PPP", "PNP", "xEs", 'P', MetaItems.CARBON_FIBER_PLATE.getStackForm(), 'N', MetaItems.NIGHTVISION_GOGGLES.getStackForm(), 'E', MetaItems.ENERGIUM_CRYSTAL.getStackForm());
