...
public class MetaTileEntityLoader {
    ...
    public static void init() {
        ...
        ModHandler.addShapedRecipe(true, "casing_hssg_robust", MetaBlocks.METAL_CASING.getItemVariant(HSSG_STURDY, 2), "PhP", "PFP", "PwP", 'P', new UnificationEntry(OrePrefix.plate, Materials.HSSG), 'F', new UnificationEntry(OrePrefix.frameGt, Materials.HSSG));
        ModHandler.addShapedRecipe(true, "casing_hsss_robust", MetaBlocks.METAL_CASING.getItemVariant(HSSS_RIGID, 2), "PhP", "PFP", "PwP", 'P', new UnificationEntry(OrePrefix.plate, Materials.HSSS), 'F', new UnificationEntry(OrePrefix.frameGt, Materials.HSSS));
        ModHandler.addShapedRecipe(true, "casing_hsse_sturdy", MetaBlocks.METAL_CASING.getItemVariant(HSSE_STURDY, 2), "PhP", "PFP", "PwP", 'P', new UnificationEntry(OrePrefix.plate, Materials.HSSE), 'F', new UnificationEntry(OrePrefix.frameGt, Materials.Europium));
