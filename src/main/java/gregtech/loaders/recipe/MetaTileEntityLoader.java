...
public class MetaTileEntityLoader {
    ...
    public static void init() {
        ...
        ModHandler.addShapedRecipe("transformer_hv", MetaTileEntities.TRANSFORMER[GTValues.HV - 1].getStackForm(), "UBB", "CM ", "UBB", 'M', MetaTileEntities.HULL[GTValues.MV].getStackForm(), 'C', new UnificationEntry(OrePrefix.cableGtSingle, Materials.Gold), 'B', new UnificationEntry(OrePrefix.cableGtSingle, Materials.Copper), 'U', MetaItems.ULTRA_LOW_POWER_INTEGRATED_CIRCUIT);
        ModHandler.addShapedRecipe("transformer_ev", MetaTileEntities.TRANSFORMER[GTValues.EV - 1].getStackForm(), "KBB", "CM ", "KBB", 'M', MetaTileEntities.HULL[GTValues.HV].getStackForm(), 'C', new UnificationEntry(OrePrefix.cableGtSingle, Materials.Aluminium), 'B', new UnificationEntry(OrePrefix.cableGtSingle, Materials.Gold), 'K', MetaItems.LOW_POWER_INTEGRATED_CIRCUIT);
        ModHandler.addShapedRecipe("transformer_iv", MetaTileEntities.TRANSFORMER[GTValues.IV - 1].getStackForm(), "KBB", "CM ", "KBB", 'M', MetaTileEntities.HULL[GTValues.EV].getStackForm(), 'C', new UnificationEntry(OrePrefix.cableGtSingle, Materials.Tungsten), 'B', new UnificationEntry(OrePrefix.cableGtSingle, Materials.Aluminium), 'K', MetaItems.POWER_INTEGRATED_CIRCUIT);
        ...
        ModHandler.addShapedRecipe("transformer_zpm", MetaTileEntities.TRANSFORMER[GTValues.ZPM - 1].getStackForm(), "KBB", "CM ", "KBB", 'M', MetaTileEntities.HULL[GTValues.LuV].getStackForm(), 'C', new UnificationEntry(OrePrefix.cableGtSingle, Materials.Naquadah), 'B', new UnificationEntry(OrePrefix.cableGtSingle, Materials.VanadiumGallium), 'K', MetaItems.HIGH_POWER_INTEGRATED_CIRCUIT);
        ...
        ModHandler.addShapedRecipe("distillation_tower", MetaTileEntities.DISTILLATION_TOWER.getStackForm(), "CBC", "FMF", "CBC", 'M', MetaTileEntities.HULL[GTValues.HV].getStackForm(), 'B', new UnificationEntry(OrePrefix.pipeLarge, Materials.StainlessSteel), 'C', new UnificationEntry(OrePrefix.circuit, Tier.Extreme), 'F', MetaItems.ELECTRIC_PUMP_HV);
        ...
        ModHandler.addShapedRecipe("super_tank_1",MetaTileEntities.Super_tank[0].getStackForm(),"CPC","PHP","CFC",'C',new UnificationEntry(OrePrefix.circuit, Tier.Primitive),'P',new UnificationEntry(OrePrefix.plate, Materials.WroughtIron),'F',MetaItems.ELECTRIC_PUMP_LV.getStackForm(),'H',MetaBlocks.hermetic_casings.getItemVariant(gregtech.common.blocks.HermeticCasings.HermeticCasingsType.Hermetic_casing_ulv));
        ModHandler.addShapedRecipe("super_tank_2",MetaTileEntities.Super_tank[1].getStackForm(),"CPC","PHP","CFC",'C',new UnificationEntry(OrePrefix.circuit, Tier.Basic),'P',new UnificationEntry(OrePrefix.plate, Materials.Steel),'F',MetaItems.ELECTRIC_PUMP_LV.getStackForm(),'H',MetaBlocks.hermetic_casings.getItemVariant(gregtech.common.blocks.HermeticCasings.HermeticCasingsType.HermeticCasing_lv));
        ModHandler.addShapedRecipe("super_tank_3",MetaTileEntities.QUANTUM_TANK[0].getStackForm(),"CPC","PHP","CFC",'C',new UnificationEntry(OrePrefix.circuit, Tier.Good),'P',new UnificationEntry(OrePrefix.plate, Materials.Aluminium),'F',MetaItems.ELECTRIC_PUMP_MV.getStackForm(),'H',MetaBlocks.hermetic_casings.getItemVariant(gregtech.common.blocks.HermeticCasings.HermeticCasingsType.HermeticCasing_mv));
        ModHandler.addShapedRecipe("super_tank_4",MetaTileEntities.QUANTUM_TANK[1].getStackForm(),"CPC","PHP","CFC",'C',new UnificationEntry(OrePrefix.circuit, Tier.Advanced),'P',new UnificationEntry(OrePrefix.plate, Materials.StainlessSteel),'F',MetaItems.ELECTRIC_PUMP_HV.getStackForm(),'H',MetaBlocks.hermetic_casings.getItemVariant(gregtech.common.blocks.HermeticCasings.HermeticCasingsType.HermeticCasing_hv));
        ModHandler.addShapedRecipe("super_tank_5",MetaTileEntities.QUANTUM_TANK[2].getStackForm(),"CPC","PHP","CFC",'C',new UnificationEntry(OrePrefix.circuit, Tier.Extreme),'P',new UnificationEntry(OrePrefix.plate, Materials.Titanium),'F',MetaItems.ELECTRIC_PUMP_EV.getStackForm(),'H',MetaBlocks.hermetic_casings.getItemVariant(gregtech.common.blocks.HermeticCasings.HermeticCasingsType.HermeticCasing_ev));
        ModHandler.addShapedRecipe("quantum_tank_1",MetaTileEntities.QUANTUM_TANK[3].getStackForm(),"CPC","PHP","CFC",'C',new UnificationEntry(OrePrefix.circuit, Tier.Elite),'P',new UnificationEntry(OrePrefix.plate, Materials.TungstenSteel),'F',MetaItems.FIELD_GENERATOR_IV.getStackForm(),'H',MetaBlocks.hermetic_casings.getItemVariant(gregtech.common.blocks.HermeticCasings.HermeticCasingsType.HermeticCasing_iv));

        ModHandler.addShapedRecipe("super_chest_1",MetaTileEntities.super_chest[0].getStackForm(),"CPC","PFP","CPC",'C', new UnificationEntry(OrePrefix.circuit, Tier.Primitive),'P',new UnificationEntry(OrePrefix.plate, Materials.WroughtIron),'F',MetaTileEntities.WOODEN_CHEST.getStackForm());
        ModHandler.addShapedRecipe("super_chest_3",MetaTileEntities.QUANTUM_CHEST[0].getStackForm(),"CPC","PFP","CPC",'C', new UnificationEntry(OrePrefix.circuit, Tier.Good),'P',new UnificationEntry(OrePrefix.plate, Materials.Aluminium),'F',MetaTileEntities.STEEL_CHEST.getStackForm());
        ModHandler.addShapedRecipe("super_chest_4",MetaTileEntities.QUANTUM_CHEST[1].getStackForm(),"CPC","PFP","CPC",'C', new UnificationEntry(OrePrefix.circuit, Tier.Advanced),'P',new UnificationEntry(OrePrefix.plate, Materials.StainlessSteel),'F',MetaTileEntities.STAINLESS_STEEL_CHEST.getStackForm());
        ModHandler.addShapedRecipe("super_chest_5",MetaTileEntities.QUANTUM_CHEST[2].getStackForm(),"CPC","PFP","CPC",'C', new UnificationEntry(OrePrefix.circuit, Tier.Extreme),'P',new UnificationEntry(OrePrefix.plate, Materials.Titanium),'F',MetaTileEntities.TITANIUM_CHEST.getStackForm());
        ModHandler.addShapedRecipe("quantum_chest_1",MetaTileEntities.QUANTUM_CHEST[3].getStackForm(),"CPC","PHP","CFC",'C',new UnificationEntry(OrePrefix.circuit, Tier.Elite),'P',new UnificationEntry(OrePrefix.plate, Materials.TungstenSteel),'F',MetaItems.FIELD_GENERATOR_IV.getStackForm(),'H',MetaTileEntities.HULL[7].getStackForm());
        ModHandler.addShapedRecipe("quantum_chest_2",MetaTileEntities.super_chest[1].getStackForm(),"CPC","PHP","CFC",'C', new UnificationEntry(OrePrefix.circuit, Tier.Master),'P',new UnificationEntry(OrePrefix.plate, Materials.Chrome),'F',MetaItems.FIELD_GENERATOR_LUV.getStackForm(),'H',MetaTileEntities.HULL[6].getStackForm());
        ModHandler.addShapedRecipe("quantum_chest_3",MetaTileEntities.super_chest[2].getStackForm(),"CPC","PHP","CFC",'C', new UnificationEntry(OrePrefix.circuit, Tier.Ultimate),'P',new UnificationEntry(OrePrefix.plate, Materials.Iridium),'F',MetaItems.FIELD_GENERATOR_ZPM.getStackForm(),'H',MetaTileEntities.HULL[7].getStackForm());
        ModHandler.addShapedRecipe("quantum_chest_4",MetaTileEntities.super_chest[3].getStackForm(),"CPC","PHP","CFC",'C', new UnificationEntry(OrePrefix.circuit, Tier.Superconductor),'P',new UnificationEntry(OrePrefix.plate, Materials.Osmium),'F',MetaItems.FIELD_GENERATOR_UV.getStackForm(),'H',MetaTileEntities.HULL[8].getStackForm());
        ModHandler.addShapedRecipe("quantum_tank_2",MetaTileEntities.Super_tank[2].getStackForm(),"CPC","PHP","CFC",'C',new UnificationEntry(OrePrefix.circuit, Tier.Master),'P',new UnificationEntry(OrePrefix.plate, Materials.Chrome),'F',MetaItems.ELECTRIC_PUMP_LUV.getStackForm(),'H',MetaBlocks.hermetic_casings.getItemVariant(gregtech.common.blocks.HermeticCasings.HermeticCasingsType.HermeticCasing_luv));
        ModHandler.addShapedRecipe("quantum_tank_3",MetaTileEntities.Super_tank[3].getStackForm(),"CPC","PHP","CFC",'C',new UnificationEntry(OrePrefix.circuit, Tier.Ultimate),'P',new UnificationEntry(OrePrefix.plate, Materials.Iridium),'F',MetaItems.ELECTRIC_PUMP_ZPM.getStackForm(),'H',MetaBlocks.hermetic_casings.getItemVariant(gregtech.common.blocks.HermeticCasings.HermeticCasingsType.HermeticCasing_zpm));
        ModHandler.addShapedRecipe("quantum_tank_4",MetaTileEntities.Super_tank[4].getStackForm(),"CPC","PHP","CFC",'C',new UnificationEntry(OrePrefix.circuit, Tier.Superconductor),'P',new UnificationEntry(OrePrefix.plate, Materials.Osmium),'F',MetaItems.ELECTRIC_PUMP_UV.getStackForm(),'H',MetaBlocks.hermetic_casings.getItemVariant(gregtech.common.blocks.HermeticCasings.HermeticCasingsType.HermeticCasing_uv));
