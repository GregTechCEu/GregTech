...
public class AssemblyLineLoader {
    public static void init() {
        ...
        RecipeMaps.ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .inputs(MetaItems.ENERGY_LAPOTRONIC_ORB_CLUSTER.getStackForm(8))
                ...
                .researchItem(MetaItems.ENERGY_LAPOTRONIC_ORB_CLUSTER.getStackForm())
                .outputs(MetaItems.ENERGY_LAPOTRONIC_MODULE.getStackForm())
                .duration(2000)
                .EUt(100000)
                .buildAndRegister();
        ...
        RecipeMaps.ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .inputs(MetaItems.WETWARE_SUPER_COMPUTER_UV.getStackForm(4))
                .inputs(MetaItems.ENERGY_LAPOTRONIC_MODULE.getStackForm(8))
                ...
                .outputs(MetaItems.ENERGY_LAPOTRONIC_CLUSTER.getStackForm())
                .researchItem(MetaItems.ENERGY_LAPOTRONIC_MODULE.getStackForm())
                .duration(2000)
                .EUt(200000)
                .buildAndRegister();
        ...
        RecipeMaps.ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .inputs(MetaItems.WETWARE_MAINFRAME_UHV.getStackForm())
                .inputs(MetaItems.WETWARE_MAINFRAME_UHV.getStackForm())
                .inputs(MetaItems.ENERGY_LAPOTRONIC_CLUSTER.getStackForm(8))
                ...
                .researchItem(MetaItems.ENERGY_LAPOTRONIC_CLUSTER.getStackForm())
                .outputs(MetaItems.ULTIMATE_BATTERY.getStackForm())
                .duration(2000)
                .EUt(300000)
                .buildAndRegister();
        ...
        RecipeMaps.ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .researchItem(OreDictUnifier.get(OrePrefix.wireGtSingle, Materials.IndiumTinBariumTitaniumCuprate))
        ...
        RecipeMaps.ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .researchItem(OreDictUnifier.get(OrePrefix.plate, Materials.Europium))
        ...
        RecipeMaps.ASSEMBLY_LINE_RECIPES.recipeBuilder()
                ...
                .researchItem(OreDictUnifier.get(OrePrefix.plate, Materials.Americium))
