...
//            .duration(72000).EUt(VA[HV]).buildAndRegister();
    ...
    private static void registerAssemblerRecipes() {
        ...
        ASSEMBLER_RECIPES.recipeBuilder().EUt(16).input(plate, HSSG, 4).input(plate, Europium, 2).inputs(MetaBlocks.METAL_CASING.getItemVariant(MetalCasingType.TUNGSTENSTEEL_ROBUST)).outputs(MetaBlocks.METAL_CASING.getItemVariant(MetalCasingType.HSSG_ROBUST, 2)).duration(50).buildAndRegister();
