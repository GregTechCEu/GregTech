...
public class MetaTileEntityMachineRecipeLoader {
    ...
    public static void init() {
        ...
        registerHatchBusRecipe(UV, FLUID_IMPORT_HATCH[UV], FLUID_EXPORT_HATCH[UV], TUNGSTENSTEEL_DRUM.getStackForm());
        registerHatchBusRecipe(UHV, FLUID_IMPORT_HATCH[UHV], FLUID_EXPORT_HATCH[UHV], TUNGSTENSTEEL_DRUM.getStackForm());
        ...
        registerHatchBusRecipe(UV, ITEM_IMPORT_BUS[UV], ITEM_EXPORT_BUS[UV], TUNGSTENSTEEL_CRATE.getStackForm());
        registerHatchBusRecipe(UHV, ITEM_IMPORT_BUS[UHV], ITEM_EXPORT_BUS[UHV], TUNGSTENSTEEL_CRATE.getStackForm());
